...
(function($){
			...
			if ($('#'+id).length == 0) {
				...
				table.append(
					$(options.rowTpl)
						...
						.append($(options.cellTpl).append($(options.buttonNumberTpl).html(5000).addClass('uno')))
					).append(
					$(options.rowTpl)
						...
						.append($(options.cellTpl).append($(options.buttonNumberTpl).html(10000).addClass('uno')))
					).append(
					$(options.rowTpl)
						...
						.append($(options.cellTpl).append($(options.buttonNumberTpl).html(20000).addClass('uno')))
					).append(
					$(options.rowTpl)
						...
						.append($(options.cellTpl).append($(options.buttonNumberTpl).html(50000).addClass('uno')))
					).append(
					$(options.rowTpl).append($(options.displayCellTplink))
						.append($(options.cellTpl).append($(options.buttonNumberTpl).html(100000).addClass('uno')))
					).append(
					$(options.rowTpl).append($(options.displayCellTplink))
				...
				// Special event for the uno buttons
				$('#'+id+' .uno').bind('click', function(){
					var val = $('#'+id+' .nmpd-display').val()*1;
					nmpd.setValue(val+$(this).text()*1);
				});
	...
	*/
	...
	$.fn.numpad.defaults = {
		...
		displayCellTplink: '<td colspan="4"></td>',
		rowTpl: '<tr></tr>',
		cellTpl: '<td></td>',
