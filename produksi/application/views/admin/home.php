          ...
          <div class="page-content">
            ...
            <div class="page-header">
              <div class="row">
                ...
                <div class="col-md-4">
                    <a href="<?php echo base_url('admin/home/login_outlet');?>" class="btn btn-primary">HALAMAN OUTLET</a>
                    <a href="<?php echo base_url('admin/home/login_produksi');?>" class="btn btn-primary">HALAMAN PRODUKSI</a>
                </div>
              </div>
            </div><!-- /.page-header -->
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-7">
                        ...
                        <div class="row" style="margin-bottom:20px">
                          ...
                          <div class="col-md-3" style="padding:0px">
                            <div style="width:100%;border:0px" class="infobox infobox-blue">
                              <div class="infobox-icon">
                          ...
                          <div class="col-md-3" style="padding:0px">
                            <div style="width:100%;border:0px" class="infobox infobox-red">
                              <div class="infobox-icon">
                          ...
                          <div class="col-md-3" style="padding:0px">
                            <div style="width:100%;border:0px" class="infobox infobox-orange2">
