                    ...
                    <form method="post" id="formPeriode" class="form-horizontal" action="">
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          ...
                          <?php if ($print!="true") { ?>
                          <a target="_blank" href="<?php echo base_url() ?>outlet/laporan_penjualan/rekap_per_area?print=true" class="btn btn-inverse">Cetak</a>
                          <?php } ?>
                        </div>
                      </div>
                    </form>
                      ...
                      <table id="mytable" class="table table-striped table-bordered table-hover">
                        ...
                        foreach ($data_sales_from_orders as $key_s):
                          $res_member_from_orders = $this->db->select('o.pembeli, o.bukan_member, m.nama, m.alamat, m.telp')
                                                             ...
                                                             ->join('member m', 'o.pembeli=m.id_member AND o.id_users=u.id_users AND o.id_toko=m.id_toko', 'left')
