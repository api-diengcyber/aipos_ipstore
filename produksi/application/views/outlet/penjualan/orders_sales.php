          ...
          <div class="page-content">
            ...
            <div class="row">
              <div class="col-xs-12">
                ...
                <form action="<?php echo base_url() ?>outlet/penjualan_retail/orders_sales_action" method="post">
                  ...
                  <a href="<?php echo base_url() ?>outlet/penjualan_retail/orders_sales_group" class="btn btn-default">Kembali</a>
                </form>
                <!-- PAGE CONTENT ENDS -->
              </div><!-- /.col -->
            </div><!-- /.row -->
