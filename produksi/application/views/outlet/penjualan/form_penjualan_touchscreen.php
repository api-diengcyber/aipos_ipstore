        ...
        <div class="col-xs-12">
          ...
          <div class="row" style="padding-top:10px">
            <div class="col-md-6 col-xs-12">
              <div class="" style="margin: 0px 10px 0px 0px;">
                <form>
                  <div class="row">
                    ...
                    <input type="hidden" class="form-control tgl_penjualan" id="datepicker1" placeholder="Tgl Order" value="<?php echo $tgl_order; ?>" />
                  ...
                  <div class="row">
                    ...
                    <div class="panelPembayaranLainnya hide" >
                      <div class="row">
                        ...
                        <div class="form-group col-xs-3 p-0">
                      ...
                      <div class="lainya">
                        <div class="input-group form-group">
                          ...
                          <input type="text" class="deadline2" placeholder="Hari" value="30" maxlength="11" style="border-radius:0px 5px 5px 0px!important"/>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="row table-info" style="height:60vh;overflow-y:scroll;margin-bottom: 10px;">
              ...
              <div class="row" style="margin:0px">
                ...
                <div class="col-md-3 col-xs-12">
                    <button type="button" id="btn-selesai" class="btn-selesai btn-block btn btn-primary btn-round no-border">Selesai</button>
                </div>
              </div>
            </div>
...
<script type="text/javascript">
  ...
  $(document).on('change, keyup',function() {
    ...
    $(".btn-selesai").on('click', function(e) {
      e.preventDefault();
      if(app_total > 0){
        if (pembayaran=='1' || pembayaran=='3') {if (ibarang > 0) {
          
          let el = $(this);
          el.attr("disabled","disabled");

          var fd = new FormData();
          fd.append("id_pembeli", (id_pembeli!='null'||!id_pembeli)?id_pembeli:"");
            ...
            buttons: [
              {
                ...
                "class" : "btn btn-primary btn-minier btn-selesai-temenan",
                "disabled" : "disabled",
                "id" : "btnSubmit",
                click: function() {
                  fd.append("bayar", $("#bayar").val().replace(/\./g,''));
                  fd.append("sisa", $("#sisa").val().replace(/\./g,''));
  ...
  var calcPembayaran = function() {
    ...
    if(sisa == 0){
      ...
      sisatopositif = sisa;
      statBayar = 1;
      $(".btn-selesai-temenan").removeAttr("disabled");
    } else if(sisa < 0){
      $(".btn-selesai-temenan").removeAttr("disabled");
      // ada sisa / kembalian //
