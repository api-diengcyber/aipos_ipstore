            ...
            <div class="row">
              ...
              <div class="col-md-6">
                  ...
                  <div class="form-group">
                      ...
                      <h3 style="margin:0px;" id="showPPn">Rp <?php echo number_format($order->nominal+$order->ongkir,0,',','.') ?></h3>
                  </div>
              </div><!-- /.col -->
            </div>
            ...
            <div class="row">
              <div class="col-md-12">
                  <table id="" class="table table-condensed table-bordered table-hover">
                    ...
                    $total_harga = $total_harga+$order->ongkir;
                    $colspan = 5;
                    ...
                    ?>
                        <tr>
                          <th colspan="<?php echo $colspan+1 ?>" style="text-align:right">Total Harga</th>
    ...
    $("#btnCetak").click(function(){
      ...
      $.ajax({
        ...
        success: function(response){
            ...
            var myWindow = window.open("<?php echo base_url() ?>outlet/penjualan_retail/cetak_nota_penjualan/<?php echo $order->no_faktur ?>", "MsgWindow"+no, "width=300,height=400");
            no++;
        },
