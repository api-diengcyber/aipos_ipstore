                      ...
                      <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>Rp <span style='float:right;'><?php echo number_format($key->hutang,0,',','.') ?></span></td>
                            <td>Rp <span style='float:right;'><?php echo number_format($key->dp,0,',','.') ?></span></td>
                            <td>Rp <span style='float:right;'><?php echo number_format($key->kurang-$key->dp,0,',','.') ?></span></td>
                          </tr>
                          <?php
                          $total_hutang += $key->hutang;
                          $total_bayar += $key->dp;
                          $total_kurang += $key->kurang-$key->dp;
                          $no++;
                          endforeach;
                          ?>
                        </tbody>
                        <tfoot>
                          <tr>
                            ...
                            <td>Rp <span style='float:right;'><?php echo number_format($total_kurang,0,',','.') ?></span></td>
                          </tr>
                        </tfoot>
                      </table>
                    </div>
