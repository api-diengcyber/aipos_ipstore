        ...
        <div class="main-content-inner">
          ...
          <div class="page-content">
            ...
            <div class="row">
              <div class="col-md-6">
                <!-- PAGE CONTENT BEGINS -->
                    ...
                    <div class="form-group">
                        <label for="bigint">Barcode <?php echo form_error('barcode') ?> <a href="<?php echo base_url() ?>outlet/produk_retail/create/1"> (Buat Barcode) </a></label> 
                    ...
                    <div class="form-group">
                        <label for="int">Harga Outlet <?php echo form_error('harga_1') ?></label>
                    ...
                    <div class="form-group">
                        <label for="int">Harga Reseller Kecil <?php echo form_error('harga_2') ?></label>
              ...
              <div class="col-md-6">
                    <div class="form-group">
                        <label for="int">Harga Reseller Besar <?php echo form_error('harga_3') ?></label>
                    ...
                    <div class="form-group">
                        <label for="int">Harga Agen Kecil <?php echo form_error('harga_4') ?></label>
                    ...
                    <div class="form-group">
                        <label for="int">Harga Agen Besar <?php echo form_error('harga_5') ?></label>
                    ...
                    <div class="form-group">
                        <label for="int">Harga Luar Kota / Online <?php echo form_error('harga_6') ?></label>
                    ...
                    <div class="form-group">
                        <label for="int">Harga Distributor <?php echo form_error('harga_7') ?></label>
                        <input type="text" class="form-control" name="harga_7" id="harga_7" style="text-align: right;" maxlength="20" placeholder="0" value="<?php echo $harga_7; ?>" />
                    </div>
                    <div class="form-group">
            ...
            <div class="row">
              <div class="col-md-4">
                    ...
                    <div class="form-group">
                      Ket: <br>
                       - Minimal Grosir hanya berlaku untuk Harga Outlet saja. <br>
                       - Jika Jumlah melebihi mingros yang ditentukan, Harga Outlet akan otomatis menjadi Harga Reseller Kecil. <br>
                    </div>
              </div>
              <div class="col-md-4">
                    <div class="form-group">
            ...
            <div class="row">
              <div class="col-md-12">
                <center>
                    ...
                    <a href="<?php echo site_url('outlet/produk_retail') ?>" class="btn btn-default">Cancel</a>
                </center>
              </div>
            </div>
            </form>
            <?php } else { ?>
              <?php if ($jml_kategori < 1) { ?>
                ...
                <a href="<?php echo base_url() ?>outlet/kategori_produk_retail/create" class="btn btn-primary">Tambah Kategori</a>
              <?php } ?>
              <hr />
              <?php if ($jml_satuan < 1) { ?>
                <h4>Data Satuan Masih Kosong </h4>
                <a href="<?php echo base_url() ?>outlet/satuan_produk/create" class="btn btn-primary">Tambah Satuan</a>
              <?php } ?>
            <?php }; ?>
          </div><!-- /.page-content -->
        </div>
...
<script>
jQuery(function($){
  $("#harga_1, #harga_2, #harga_3, #harga_4, #harga_5, #harga_6, #hpp").keyup(function(){
