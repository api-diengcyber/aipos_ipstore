              ...
              <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                    ...
                    <form method="post" id="formPeriode" class="form-horizontal" action="">
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          ...
                          <?php if ($print!="true") { ?>
                          <a target="_blank" href="<?php echo base_url() ?>produksi/laporan_piutang/rekap_area?print=true" class="btn btn-inverse">Cetak</a>
                          <?php } ?>
                        </div>
                      </div>
                    </form>
                    ...
                    $res_member_from_piutang = $this->db->select('p.id_pembeli, p.tanggal, m.kode, m.nama, m.alamat, m.telp')
                                                        ...
                                                        ->join('member m', 'p.id_pembeli=m.id_member AND p.id_users=m.id_users AND p.id_toko=m.id_toko')
