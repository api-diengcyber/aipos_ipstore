        ...
        <div class="main-content-inner">
          <div class="breadcrumbs ace-save-state breadcrumbs-fixed" id="breadcrumbs">
            <ul class="breadcrumb">
              ...
              <li class="active">Laporan Penjualan Rinci per Area</li>
            </ul><!-- /.breadcrumb -->
          ...
          <div class="page-content">
            ...
            <div class="page-header">
              <h1>
                Laporan Penjualan Rinci per Area
                ...
                <!-- PAGE CONTENT BEGINS -->
                    ...
                    <form method="post" id="formPeriode" class="form-horizontal" action="">
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          ...
                          <?php if ($print!="true") { ?>
                          <a target="_blank" href="<?php echo base_url() ?>produksi/laporan_penjualan/rinci_per_area?print=true" class="btn btn-inverse">Cetak</a>
                          <?php } ?>
                        </div>
                      </div>
                    </form>
                    ...
                    <div class="table-responsive">
                      ...
                      <div class="text-center">
                         <h1 style="margin-top:15px;margin-bottom:5px;">Laporan Penjualan Rinci per Area</h1>
                      ...
                      <table id="mytable" class="table table-striped table-bordered table-hover">
                        ...
                        foreach ($data_sales_from_orders as $key_s):
                          $res_member_from_orders = $this->db->select('o.pembeli, o.bukan_member, m.nama, m.alamat, m.telp')
                                                             ...
                                                             ->join('member m', 'o.pembeli=m.id_member AND m.id_users=u.id_users AND o.id_toko=m.id_toko', 'left')
                          ...
                          foreach ($res_member_from_orders as $key_m):
                            ...
                            foreach ($res_orders as $key):
                              if ($key->pembayaran=="2") { // kredit / hutang
                                $row_piutang = $this->db->select('p.*')
                                                        ->from('piutang p')
                              ...
                              $res_orders_detail = $this->db->select('od.*, pr.nama_produk, sp.satuan')
                                                            ...
                                                            ->join('produk_retail pr', 'od.id_produk=pr.id_produk_2 AND u.id_users=pr.id_users AND od.id_toko=pr.id_toko')
                              ...
                              foreach ($res_orders_detail as $key_od):
                                ...
                                $thnet = ($total-$hpp_netto);
                                $margin = ($thnet>0&&$hpp_netto>0)?$thnet/$hpp_netto*100:0;
                        ?>
                          <tr>
                            ...
                            <td><?php echo $key_od->nama_produk ?></td>
                            <td><?php echo $key_od->satuan ?></td>
                            <td class="text-center"><?php echo $key_od->jumlah ?></td>
                            <td class="text-right"><?php echo number_format($key_od->harga_jual,0,',','.') ?></td>
                            <td class="text-right"><?php echo number_format($jumlah,0,',','.') ?></td>
                            <td class="text-right"><?php echo number_format($diskon_nominal,0,',','.') ?></td>
                            <td class="text-right"><?php echo number_format($ppn_nominal,0,',','.') ?></td>
                            <td class="text-right"><?php echo number_format($total,0,',','.') ?></td>
                            <td class="text-right"><?php echo number_format($hpp_netto,0,',','.') ?></td>
                        ...
                        <?php
                              ...
                              endforeach;
                        ?>
                          <tr style="background-color: #6ed6e3;">
                            <th colspan="3"></th>
                            <th colspan="3" class="text-left">SUBTOTAL NO. FAKTUR <?php echo $key->no_faktur ?></th>
                            <th class="text-right"><?php echo number_format($sub_od_qty,0,',','.') ?></th>
                            <th class="text-right"><?php // echo number_format($sub_od_harga_satuan,0,',','.') ?></th>
                            <th class="text-right"><?php echo number_format($sub_od_jumlah,0,',','.') ?></th>
                            <th class="text-right"><?php echo number_format($sub_od_diskon,0,',','.') ?></th>
                            <th class="text-right"><?php echo number_format($sub_od_ppn,0,',','.') ?></th>
                            <th class="text-right"><?php echo number_format($sub_od_total,0,',','.') ?></th>
                            <th class="text-right"><?php echo number_format($sub_od_hpp,0,',','.') ?></th>
                            <th class="text-right"><?php // echo number_format($sub_od_margin,0,',','.') ?></th>
                          </tr>
                        <?php
                            ...
                            endforeach;
                        ?>
                          <tr style="background-color: #f4e669;">
                            <th colspan="2"></th>
                            <th colspan="4" class="text-left">SUBTOTAL DEBITUR <?php echo $key_m->nama ?></th>
                            <th class="text-right"><?php echo number_format($sub_m_qty,0,',','.') ?></th>
                            <th class="text-right"><?php // echo number_format($sub_m_harga_satuan,0,',','.') ?></th>
                            <th class="text-right"><?php echo number_format($sub_m_jumlah,0,',','.') ?></th>
                            <th class="text-right"><?php echo number_format($sub_m_diskon,0,',','.') ?></th>
                            <th class="text-right"><?php echo number_format($sub_m_ppn,0,',','.') ?></th>
                            <th class="text-right"><?php echo number_format($sub_m_total,0,',','.') ?></th>
                            <th class="text-right"><?php echo number_format($sub_m_hpp,0,',','.') ?></th>
                            <th class="text-right"><?php // echo number_format($sub_m_margin,0,',','.') ?></th>
                          </tr>
                        <?php
                            $sub_s_qty += $sub_m_qty;
                        ...
                        ?>
                          <tr style="background-color: #5eff5e;">
                            <th></th>
                            <th colspan="5" class="text-left">SUBTOTAL <?php echo $key_s->first_name." ".$key_s->last_name ?></th>
                            <th class="text-right"><?php echo number_format($sub_s_qty,0,',','.') ?></th>
                            <th class="text-right"><?php // echo number_format($sub_s_harga_satuan,0,',','.') ?></th>
                            <th class="text-right"><?php echo number_format($sub_s_jumlah,0,',','.') ?></th>
                            <th class="text-right"><?php echo number_format($sub_s_diskon,0,',','.') ?></th>
                            <th class="text-right"><?php echo number_format($sub_s_ppn,0,',','.') ?></th>
                            <th class="text-right"><?php echo number_format($sub_s_total,0,',','.') ?></th>
                            <th class="text-right"><?php echo number_format($sub_s_hpp,0,',','.') ?></th>
                            <th class="text-right"><?php // echo number_format($sub_s_margin,0,',','.') ?></th>
                          </tr>
                        <?php 
                          $no++;
                          $total_qty += $sub_s_qty;
                        ...
                        $style_inverse = "";
                        if ($print!="true") {
                          $style_inverse = "background-color:#000;color:#fff;";
                        }
                        ?>
                        </tbody>
                        <tfoot>
                          <tr style="background-color:#337ab7;color:#fff;">
                            <th colspan="6">GRAND TOTAL AREA <?php echo $nama_area ?> PERIODE <?php echo $awal_periode ?> - <?php echo $akhir_periode ?></th>
                            <th class="text-right"><?php echo number_format($total_qty,0,',','.') ?></th>
                            <th class="text-right"><?php // echo number_format($total_harga_satuan,0,',','.') ?></th>
                            <th class="text-right"><?php echo number_format($total_jumlah,0,',','.') ?></th>
                            <th class="text-right"><?php echo number_format($total_diskon,0,',','.') ?></th>
                            <th class="text-right"><?php echo number_format($total_ppn,0,',','.') ?></th>
                            <th class="text-right"><?php echo number_format($total_total,0,',','.') ?></th>
                            <th class="text-right"><?php echo number_format($total_hpp,0,',','.') ?></th>
                            <th class="text-right"><?php // echo number_format($total_margin,0,',','.') ?></th>
                          </tr>
                          <tr style="<?php echo $style_inverse ?>">
                            <th colspan="8" class="text-right">TOTAL PENJUALAN</th>
                            <th colspan="6" class="text-right"><?php echo number_format($total_total,0,',','.') ?></th>
                          </tr>
                          <tr style="<?php echo $style_inverse ?>">
                            <th colspan="8" class="text-right">TUNAI</th>
                            <th colspan="6" class="text-right"><?php echo number_format(0,0,',','.') ?></th>
                          </tr>
                          <tr style="<?php echo $style_inverse ?>">
                            <th colspan="8" class="text-right">KREDIT</th>
                            <th colspan="6" class="text-right"><?php echo number_format(0,0,',','.') ?></th>
                          </tr>
                          <tr style="<?php echo $style_inverse ?>">
                            <th colspan="8" class="text-right">HARGA POKOK PENJUALAN</th>
                            <th colspan="6" class="text-right"><?php echo number_format($total_hpp,0,',','.') ?></th>
                          </tr>
                        </tfoot>
                      </table>
                    </div>
