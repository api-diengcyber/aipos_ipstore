        ...
        <div class="main-content-inner">
          <div class="breadcrumbs ace-save-state breadcrumbs-fixed" id="breadcrumbs">
            <ul class="breadcrumb">
              ...
              <li class="active">Laporan Pembelian Rekap Semua Supplier</li>
            </ul><!-- /.breadcrumb -->
          ...
          <div class="page-content">
            ...
            <div class="page-header">
              <h1>
                Laporan Pembelian Rekap Semua Supplier
                ...
                <!-- PAGE CONTENT BEGINS -->
                    ...
                    <form method="post" id="formPeriode" class="form-horizontal" action="">
                      <div class="row">
                        ...
                        <div class="col-md-4">
                          ...
                          <?php if ($print!="true") { ?>
                          <a target="_blank" href="<?php echo base_url() ?>produksi/laporan_pembelian/rekap?print=true" class="btn btn-inverse">Cetak</a>
                          <?php } ?>
                        </div>
                      </div>
                    </form>
                    ...
                    <div class="table-responsive">
                      ...
                      <div class="text-center">
                         <h1 style="margin-top:15px;margin-bottom:5px;">Laporan Pembelian Rekap Semua Supplier</h1>
                      ...
                      <table id="mytable" class="table table-striped table-bordered table-hover">
                        ...
                        ?>
                          <tr>
                            <td><?php echo $no ?></td>
                            <td><?php echo $key_f->nama_supplier ?></td>
                        ...
                        <tfoot>
                          <tr style="background-color:yellow;">
                            <th colspan="4" class="text-center">GRAND TOTAL PEMBELIAN PERIODE <?php echo $awal_periode ?> - <?php echo $akhir_periode ?></th>
