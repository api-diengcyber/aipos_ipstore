                      ...
                      <table id="mytable" class="table table-striped table-bordered table-hover">
                        ...
                        ?>
                          <tr>
                            ...
                            <?php if ($print!=true) { ?>
                            <td class="text-center"><a onclick="return confirm('Are you sure ? ')" href="<?php echo base_url() ?>produksi/jurnal/delete/<?php echo $key->id ?>" class="btn btn-danger btn-xs"><i class="ace-icon fa fa-trash"></i></a></td>
                            <?php } ?>
                          </tr>
                        <?php 
                          if ($show_kode) {
