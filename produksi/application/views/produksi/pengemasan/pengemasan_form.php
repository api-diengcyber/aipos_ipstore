          ...
          <div class="page-content">
            ...
            <div class="row">
              <div class="col-xs-12">
                ...
                <form action="<?php echo base_url() ?>produksi/pengemasan/create_action" method="post">
                  <div class="row">
                    <div class="col-xs-12">
                      <div class="box">
                        <div class="row">
                      ...
                      <div class="box">
                        <div class="row">
                          <div class="col-xs-12">
                            ...
                            <div class="form-group">
                              <label>Ambil data inkubasi</label>
                              <div class="row">
                                <div class="col-md-6">
                                  <input type="text" class="form-control" name="tgl_produksi" id="datepicker2" value="<?php echo $tgl ?>">
                                </div>
                                <div class="col-md-6">
                            ...
                            <!-- <div>Data Produksi Tanggal : <?php // echo $tgl_produksi ?></div>
                      ...
                      <div class="box box-sisa" style="display:none;">
                        <div class="row">
                          <div class="col-xs-12">
                            <h4>Sisa</h4>
                            <div id="panel_produksi_sisa"></div>
                          </div>
                        </div>
                      </div>
                      <div class="box">
      ...
      <script type="text/javascript">
        $(document).ready(function(){
            ...
            $.ajax({
              ...
              success: function(response){
                if (response.status=="ok") {
                  ...
                  $("#id_inkubasi").val('');
                  $("#modal-message").html(response.msg);
                }
              },
              error: function(){
                $("#table-review tbody").html('');
          ...
          $(".btn-add-inkubasi").on("click", function(){
            ...
            $.ajax({
              url: '<?php echo base_url() ?>produksi/pengemasan/add_inkubasi',
              type: 'post',
              data: 'id='+id_inkubasi,
              success: function(response) {
                $("#myModal").modal("hide");
                $('input[name="tgl_produksi"]').datepicker("destroy");
                $('input[name="tgl_produksi"]').removeClass("hasDatepicker").removeAttr('id').attr("readonly", "readonly");
                listTempBahan();
              },
              error: function() {
                $('input[name="tgl_produksi"]').datepicker("destroy");
          ...
          function listTempBahan() {
            ...
            $.ajax({
              url: '<?php echo base_url() ?>produksi/pengemasan/list_temp',
              type: 'get',
              success: function(response){
                $('[type="submit"]').removeAttr("disabled");
                if (response.status=="ok") {
                  $("#panel_produksi").html(response.data);
                  $("#panel_produksi_sisa").html(response.data_sisa);
                  $(".box-sisa").show();
                  jqueryTempBahan();
                }
              }, error: function() {
          ...
          function jqueryTempBahan() {
            ...
            function updateTempBahan(id, data) {
              ...
              $.ajax({
                url: '<?php echo base_url() ?>produksi/pengemasan/update_temp_bahan',
                type: 'post',
                data: 'id='+id+'&'+data,
                success: function(response){
                  listTempBahan();
            ...
            $("#table_produksi .btn-hapus-temp").on("click", function(e){
              ...
              $.ajax({
                url: '<?php echo base_url() ?>produksi/pengemasan/hapus_temp',
                type: 'post',
                data: 'id='+id,
                success: function(response) {
                  listTempBahan();
          ...
          function listTempPengemasan() {
            $('[type="submit"]').attr("disabled", "disabled");
            $.ajax({
              url: '<?php echo base_url() ?>produksi/pengemasan/list_temp_pengemasan',
              type: 'get',
              success: function(response){
                $('[type="submit"]').removeAttr("disabled");
                if (response.status=="ok") {
          ...
          function jqueryTempPengemasan() {
            ...
            function updateTempPengemasan(id, data) {
              ...
              $.ajax({
                url: '<?php echo base_url() ?>produksi/pengemasan/update_temp',
                type: 'post',
                data: 'id='+id+'&'+data,
                success: function(response){
                  listTempPengemasan();
          ...
          function listTempBarangJadi() {
            $('[type="submit"]').attr("disabled", "disabled");
            $.ajax({
              url: '<?php echo base_url() ?>produksi/pengemasan/list_temp_produk',
              type: 'get',
              success: function(response){
                $('[type="submit"]').removeAttr("disabled");
                if (response.status=="ok") {
          ...
          function jqueryTempBarangJadi() {
            ...
            function updateTempBarangJadi(id, data) {
              ...
              $.ajax({
                url: '<?php echo base_url() ?>produksi/pengemasan/update_temp_produk',
                type: 'post',
                data: 'id='+id+'&'+data,
                success: function(response){
                  listTempBarangJadi();
