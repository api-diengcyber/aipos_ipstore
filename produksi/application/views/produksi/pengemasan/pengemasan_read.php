            ...
            <div class="row">
              <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                      ...
                      <div class="box">
                        <div class="row">
                          <div class="col-xs-12">
                            ...
                            <?php 
                            foreach ($data_group_barang as $key_g):
                              $data_barang = $this->db->select('pb.*, pr.nama_produk')
                                                    ...
                                                    ->where('pb.id_pengemasan', $id_pengemasan)
                                                    ->where('pb.posisi', 0)
                                                    ->where('u.level', 2)
                                                    ->where('pb.id_inkubasi', $key_g->id_inkubasi)
                                                    ->get()->result();
                            ?>
                            <div>Data Produksi Tanggal : <?php echo $key_g->tgl ?></div>
                            <table class="table table-bordered" id="table_produksi">
                              ...
                              ?>
                                <tr>
                                  ...
                                  <td><?php echo $key->stok_inkubasi ?></td>
                                </tr>
                              <?php
                                $no++;
                              endforeach;
                        ...
                        <div class="row">
                          <div class="col-xs-12">
                            ...
                            <table class="table table-bordered" id="table_barang">
                              ...
                              <?php 
                              $no = 1;
                              foreach ($data_barang_pengemasan as $key):
                              ?>
                                <tr>
                                  <td><?php echo $no ?></td>
                                  <td><?php echo $key->nama_produk ?></td>
                        ...
                        <div class="row">
                          <div class="col-xs-12">
                            ...
                            <table class="table table-bordered" id="table_barang_jadi">
                              ...
                              <?php 
                              $no = 1;
                              foreach ($data_barang_produk as $key):
                              ?>
                                <tr>
                                  <td><?php echo $no ?></td>
                                  <td><?php echo $key->nama_produk ?></td>
                          ...
                          <div class="col-xs-12">
                            ...
                            <div class="row">
                              <div class="col-md-2">
                                <div class="radio">
                                  <label>
                                    <input name="progress" type="radio" class="ace" value="20" <?php echo $progress==20?"checked":"" ?> disabled />
                              ...
                              <div class="col-md-2">
                                <div class="radio">
                                  <label>
                                    <input name="progress" type="radio" class="ace" value="40" <?php echo $progress==40?"checked":"" ?> disabled />
                              ...
                              <div class="col-md-2">
                                <div class="radio">
                                  <label>
                                    <input name="progress" type="radio" class="ace" value="60" <?php echo $progress==60?"checked":"" ?> disabled />
                              ...
                              <div class="col-md-2">
                                <div class="radio">
                                  <label>
                                    <input name="progress" type="radio" class="ace" value="80" <?php echo $progress==80?"checked":"" ?> disabled />
                              ...
                              <div class="col-md-2">
                                <div class="radio">
                                  <label>
                                    <input name="progress" type="radio" class="ace" value="100" <?php echo $progress==100?"checked":"" ?> disabled />
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <a href="<?php echo base_url() ?>produksi/pengemasan" class="btn btn-default">Kembali</a>
                    </div>
                  </div>
                <!-- PAGE CONTENT ENDS -->
              </div><!-- /.col -->
