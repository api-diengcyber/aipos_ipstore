          ...
          <div class="page-content">
              ...
              <div class="col-md-6">
                <!-- PAGE CONTENT BEGINS -->
                    ...
                    <div class="form-group">
                        <label for="bigint">Barcode <?php echo form_error('barcode') ?> <a href="<?php echo base_url() ?>produksi/produk_retail/create/1"> (Buat Barcode) </a></label> 
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="jenis" id="jenis">
                          <option value="0" <?php echo $jenis==0?"selected":""; ?>>PRODUK JADI</option>
                          <option value="1" <?php echo $jenis==1?"selected":""; ?>>BAHAN</option>
                          <option value="2" <?php echo $jenis==2?"selected":""; ?>>PENGEMASAN</option>
                          <option value="3" <?php echo $jenis==3?"selected":""; ?>>INKUBASI</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="int">Harga produksi <?php echo form_error('harga_1') ?></label>
            ...
            <div class="row">
              <div class="col-md-4">
                    ...
                    <div class="form-group">
                      Ket: <br>
                       - Minimal Grosir hanya berlaku untuk Harga produksi saja. <br>
                       - Jika Jumlah melebihi mingros yang ditentukan, Harga produksi akan otomatis menjadi Harga Reseller Kecil. <br>
                    </div>
              </div>
              <div class="col-md-4">
                    <div class="form-group">
            ...
            <?php } else { ?>
              <?php if ($jml_kategori < 1) { ?>
                ...
                <a href="<?php echo base_url() ?>produksi/kategori_produk_retail/create" class="btn btn-primary">Tambah Kategori</a>
              <?php } ?>
              <hr />
              <?php if ($jml_satuan < 1) { ?>
                <h4>Data Satuan Masih Kosong </h4>
                <a href="<?php echo base_url() ?>produksi/satuan_produk/create" class="btn btn-primary">Tambah Satuan</a>
              <?php } ?>
            <?php }; ?>
          </div><!-- /.page-content -->
        </div>
