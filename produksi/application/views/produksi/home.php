              ...
              <div class="col-xs-12">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    ...
                    <div style="margin-bottom:20px">
                        <h4>Stok Inkubasi</h4>
                          <?php foreach ($data_stok_inkubasi as $key) { ?>
                          <div class="infobox infobox-green">
                            <div class="infobox-icon">
                              <i class="ace-icon fa fa-database"></i>
                            </div>
                            <div class="infobox-data">
                              <span class="infobox-data-number"><?php echo $key->total-$key->dipakai*1 ?></span>
                              <div class="infobox-content" style="font-size:11px;"><?php echo $key->nama_produk; ?></div>
                            </div>
                          </div>
                          <?php } ?>
                          <div>
                            <a href="<?php echo base_url() ?>produksi/stok/stok_inkubasi" class="btn btn-primary btn-block">
                              Selengkapnya
                            </a>
                          </div>
                    </div>
