...
class Satuan_produk extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->view->render_produksi('satuan_produk/satuan_produk_list', $data);
    } 
    
    public function json() {
        header('Content-Type: application/json');
        echo $this->Satuan_produk_model->json_produksi($this->userdata->id_toko);
    }
    ...
    public function create()
    {
        $data = array(
            ...
            'nama_modul' => $this->userdata->nama_modul,
            'button' => 'Tambah',
            'action' => site_url('produksi/satuan_produk/create_action'),
            'satuan' => set_value('satuan'),
            'id' => set_value('id'),
        );
        $this->view->render_produksi('satuan_produk/satuan_produk_form', $data);
    }
    ...
    public function create_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect(site_url('produksi/satuan_produk'));
        }
    }
    ...
    public function update($id)
    {
        ...
        $data = array(
            ...
            'nama_modul' => $this->userdata->nama_modul,
            'button' => 'Simpan',
            'action' => site_url('produksi/satuan_produk/update_action'),
