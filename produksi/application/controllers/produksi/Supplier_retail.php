...
class Supplier_retail extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->view->render_produksi('supplier/supplier_list', $data);
    }
    
    public function json() {
        header('Content-Type: application/json');
        echo $this->Supplier_retail_model->json_produksi($this->userdata->id_toko);
    }
    ...
    public function read($id) 
    {
        ...
        if ($row) {
            ...
            $this->view->render_produksi('supplier/supplier_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('produksi/supplier'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            ...
            'nama_modul' => $this->userdata->nama_modul,
            'button' => 'Tambah',
            'action' => site_url('produksi/supplier_retail/create_action'),
        ...
        $this->view->render_produksi('supplier/supplier_form', $data);
    ...
    public function create_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect(site_url('produksi/supplier_retail'));
        }
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                ...
                'nama_modul' => $this->userdata->nama_modul,
                'button' => 'Simpan',
                'action' => site_url('produksi/supplier_retail/update_action'),
    ...
    public function word()
    {
        ...
        $this->load->view('produksi/supplier/supplier_doc',$data);
    }
