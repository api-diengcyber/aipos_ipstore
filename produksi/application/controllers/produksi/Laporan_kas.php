...
class Laporan_kas extends CI_Controller {
	...
	public function harian()
	{
		...
		if ($print!="true") {
	        $this->view->render_produksi('laporan_baru/kas_harian', $data);
		} else {
			$this->load->view('produksi/laporan_baru/kas_harian', $data);
		}
	}
	...
	public function bulanan()
	{
		...
		if ($print!="true") {
	        $this->view->render_produksi('laporan_baru/kas_bulanan', $data);
		} else {
			$this->load->view('produksi/laporan_baru/kas_bulanan', $data);
		}
	}
