...
class Jurnal_retail extends CI_Controller {
	...
	public function umum_create()
	{
        ...
        if($row){
            ...
            $data = array(
                ...
                'action' => site_url('outlet/jurnal_retail/umum_create_action'),
                'id_toko' => $this->userdata->id_toko,
                'tgl' => date('d-m-Y'),
                'kode' => $kode_baru,
            ...
            $this->view->render_outlet('jurnal/umum/umum_form', $data);
        }
	}
    ...
    public function umum_create_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect(site_url('outlet/jurnal_retail/umum_create'));
        }
    }
	...
	public function penerimaan_kas_create()
	{
        ...
        if($row){
            ...
            $data = array(
                ...
                'id_modul' => $this->userdata->id_modul,
                'nama_modul' => $this->userdata->nama_modul,
                'action' => site_url('outlet/jurnal_retail/penerimaan_kas_create_action'),
                'id_toko' => $this->userdata->id_toko,
                'tgl' => date('d-m-Y'),
                'kode' => $kode_baru,
                'faktur' => set_value('faktur'),
            ...
            $this->view->render_outlet('jurnal/penerimaan_kas/penerimaan_kas_form', $data);
        }
	}
    ...
    public function penerimaan_kas_create_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect(site_url('outlet/jurnal_retail/penerimaan_kas_create'));
        }
    }
	...
	public function pengeluaran_kas_create()
	{
        ...
        if($row){
            ...
            $data = array(
                ...
                'id_modul' => $this->userdata->id_modul,
                'nama_modul' => $this->userdata->nama_modul,
                'action' => site_url('outlet/jurnal_retail/pengeluaran_kas_create_action'),
                'id_toko' => $this->userdata->id_toko,
                'tgl' => date('d-m-Y'),
                'kode' => $kode_baru,
                'faktur' => set_value('faktur'),
            ...
            $this->view->render_outlet('jurnal/pengeluaran_kas/pengeluaran_kas_form', $data);
        }
	}
    ...
    public function pengeluaran_kas_create_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect(site_url('outlet/jurnal_retail/pengeluaran_kas_create'));
        }
    }
	...
	public function bayar_piutang_create($id_piutang = NULL)
	{
        ...
        if($row){
            ...
            $data = array(
                ...
                'id_modul' => $this->userdata->id_modul,
                'nama_modul' => $this->userdata->nama_modul,
                'action' => site_url('outlet/jurnal_retail/bayar_piutang_create_action'),
                'id_toko' => $this->userdata->id_toko,
                'tgl' => date('d-m-Y'),
                'kode' => $kode_baru,
            ...
            $this->view->render_outlet('jurnal/piutang/piutang_form', $data);
        }
	}
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if($row_piutang){
                ...
                if($res_pembeli) {
                    ...
                    redirect(site_url('outlet/jurnal_retail/bayar_piutang_create'));
	...
	public function bayar_hutang_create($id_hutang = NULL)
	{
        ...
        if($row){
            ...
            $data = array(
                ...
                'id_modul' => $this->userdata->id_modul,
                'nama_modul' => $this->userdata->nama_modul,
                'action' => site_url('outlet/jurnal_retail/bayar_hutang_create_action'),
                'id_toko' => $this->userdata->id_toko,
                'tgl' => date('d-m-Y'),
                'kode' => $kode_baru,
                'faktur' => set_value('faktur'),
            ...
            $this->view->render_outlet('jurnal/hutang/hutang_form', $data);
        }
	}
    ...
    public function bayar_hutang_create_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
			...
			redirect(site_url('outlet/hutang_retail/read/'.$id));
        }
    }
	...
	public function pengaturan()
	{
        ...
        $this->view->render_outlet('jurnal/pengaturan', $data);
	}
    ...
    public function buat_jurnal()
    {
        ...
        $data = array(
            ...
            'id_modul' => $this->userdata->id_modul,
            'nama_modul' => $this->userdata->nama_modul,
            'action' => site_url('outlet/jurnal_retail/buat_jurnal_action'),
            'id' => set_value('id'),
        ...
        $this->view->render_outlet('jurnal/buat_jurnal', $data);
    }
    ...
    public function buat_jurnal_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($row_pil_transaksi) {
                ...
                redirect(site_url('outlet/jurnal_retail/buat_jurnal'));
            } else {
