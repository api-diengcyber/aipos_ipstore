...
class Pil_transaksi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->view->render_outlet('pil_transaksi/pil_transaksi_list', $data);
    } 
    ...
    public function read($id) 
    {
        ...
        if ($row) {
            ...
            $this->view->render_outlet('pil_transaksi/pil_transaksi_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('outlet/pil_transaksi'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('outlet/pil_transaksi/create_action'),
    	    'id' => set_value('id'),
        ...
        $this->view->render_outlet('pil_transaksi/pil_transaksi_form', $data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('outlet/pil_transaksi/update_action'),
