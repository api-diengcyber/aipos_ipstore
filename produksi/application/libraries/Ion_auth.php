...
class Ion_auth
{
	 ...
	 * @return bool
	 */
	public function register($identity, $password, $email, $additional_data = array(), $group_ids = array(), $data_toko = array()) //need to test email activation
	{
		...
		$se_email = false;
		if (count($data_toko) > 0) {
	        $this->db->insert('toko', $data_toko);
	        $id_toko = $this->db->insert_id();
			/* KONFIGURASI */		
			/* kategori */
			$this->db->query("INSERT INTO kategori_produk(id_kategori_2,id_toko,nama_kategori) VALUES
				('1','".$id_toko."','Makanan'),
				('2','".$id_toko."','Minuman'),
				('3','".$id_toko."','Obat'),
				('4','".$id_toko."','Elektronik'),
				('5','".$id_toko."','Pakaian'),
				('6','".$id_toko."','Komputer'),
				('7','".$id_toko."','Gerabah'),
				('8','".$id_toko."','Rokok'),
				('9','".$id_toko."','Dapur'),
				('10','".$id_toko."','Kebersihan'),
				('11','".$id_toko."','Kosmetik'),
				('12','".$id_toko."','Alat Tulis'),
				('13','".$id_toko."','Insektisida'),
				('14','".$id_toko."','Alat Dapur'),
				('15','".$id_toko."','Alat Kebersihan'),
				('16','".$id_toko."','Mainan')
			");
			/* satuan */
			$this->db->query("INSERT INTO satuan_produk(id_satuan,id_toko,satuan) VALUES
				('1','".$id_toko."','Pcs'),
				('2','".$id_toko."','Lusin'),
				('3','".$id_toko."','Kodi')
			");
			/* akun sederhana */
			$this->db->query("INSERT INTO akun_sederhana(id_akun,id_toko,jenis,nama_akun) VALUES
				('1','".$id_toko."','1','Hasil Usaha'),
				('2','".$id_toko."','1','Gaji'),
				('3','".$id_toko."','1','Bonus'),
				('4','".$id_toko."','2','Makan'),
				('5','".$id_toko."','2','Transportasi'),
				('6','".$id_toko."','2','Listrik'),
				('7','".$id_toko."','2','PDAM'),
				('8','".$id_toko."','2','Pulsa'),
				('9','".$id_toko."','2','Gaji Karyawan'),
				('10','".$id_toko."','2','Belanja Umum')
			");
			/* opsi lain lain */
			$this->db->query("INSERT INTO opsi(id_toko,id_opsi,opsi) VALUES 
				('".$id_toko."','1','0'),
				('".$id_toko."','2','1'),
				('".$id_toko."','3','1'),
				('".$id_toko."','4','1'),
				...
				('".$id_toko."','6','10')
			");
	        $additional_data['id_toko'] = $id_toko;
			$se_email = true;
			return $id_toko;
		}
		...
		else
		{
			...
			$deactivate = $this->ion_auth_model->deactivate_email($id);
