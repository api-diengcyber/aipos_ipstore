    ...
    class Gaji_model extends CI_Model {
        ...
        function get_all_between($from,$to,$gaji_perjam,$jam_lembur)
        {
            ...
            if($row_gaji_temp) {
                ...
                $gaji_perjam = ($gaji_perjam)?$gaji_perjam:5000;
                $jam_lembur = ($jam_lembur)?$jam_lembur:6000;
        ...
        function get_between($from,$to,$gaji_perjam,$jam_lembur)
        {
            ...
            foreach ($res_karyawan as $item) {
                ...
                $output[] = (object)array(
                    ...
                    "gaji"=>((str_replace(',','.',$total_jam)) * 1 * $gaji_perjam) + ((str_replace(',','.',$total_lembur)) * 1 * $jam_lembur),
                    "keterangan"=>"",
                );
            }
            return $output;
