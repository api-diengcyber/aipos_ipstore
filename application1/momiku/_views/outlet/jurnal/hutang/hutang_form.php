              ...
              <div class="col-xs-12">
                ...
                <form action="<?php echo $action ?>" method="post">
                  ...
                  <div class="text-center" style="margin-top:10px;">
                    <a href="<?php echo base_url() ?>outlet/hutang_retail/read/<?php echo $id_hutang ?>" class="btn btn-success">
                      <!-- <i class="ace-icon fa fa-trash bigger-230"></i> -->
                      Lihat
                    </a>
                    <a href="<?php echo base_url() ?>outlet/hutang_retail" class="btn btn-default">
                      <!-- <i class="ace-icon fa fa-trash bigger-230"></i> -->
                      Batal
                    </a>
