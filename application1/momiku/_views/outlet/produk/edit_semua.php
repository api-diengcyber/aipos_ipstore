          ...
          <div class="page-content">
            ...
            <div class="row">
              <div class="col-xs-12">
                ...
                <div class="row" style="margin-bottom: 10px">
                  ...
                  <div class="col-md-3">
                    <select multiple="" class="chosen-select form-control" data-placeholder="Pilih Kolom">
                      ...
                      <option value="5">H. Outlet</option>
                ...
                <a href="<?php echo base_url() ?>outlet/produk_retail" class="btn btn-default"><< Kembali</a>
...
<?php 
  ...
  function loadData(data) {
    $.ajax({
      url: '<?php echo base_url() ?>outlet/produk_retail/json',
      type: 'get',
  ...
  function saveData(data, result) {
    $.ajax({
      url: '<?php echo base_url() ?>outlet/produk_retail/simpan_semua_produk',
      type: 'post',
