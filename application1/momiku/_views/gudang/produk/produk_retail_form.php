          ...
          <div class="page-content">
              ...
              <div class="col-md-6">
                <!-- PAGE CONTENT BEGINS -->
                    ...
                    <div class="form-group">
                        <label for="bigint">Barcode <?php echo form_error('barcode') ?> <a href="<?php echo base_url() ?>gudang/produk_retail/create/1"> (Buat Barcode) </a></label> 
                    ...
                    <div class="form-group">
                        <label for="int">Harga gudang <?php echo form_error('harga_1') ?></label>
            ...
            <div class="row">
              <div class="col-md-4">
                    ...
                    <div class="form-group">
                      Ket: <br>
                       - Minimal Grosir hanya berlaku untuk Harga gudang saja. <br>
                       - Jika Jumlah melebihi mingros yang ditentukan, Harga gudang akan otomatis menjadi Harga Reseller Kecil. <br>
                    </div>
              </div>
              <div class="col-md-4">
                    <div class="form-group">
            ...
            <div class="row">
              <div class="col-md-12">
                <center>
                    ...
                    <a href="<?php echo site_url('gudang/produk_retail') ?>" class="btn btn-default">Cancel</a>
                </center>
              </div>
            </div>
            </form>
            <?php } else { ?>
              <?php if ($jml_kategori < 1) { ?>
                ...
                <a href="<?php echo base_url() ?>gudang/kategori_produk_retail/create" class="btn btn-primary">Tambah Kategori</a>
              <?php } ?>
              <hr />
              <?php if ($jml_satuan < 1) { ?>
                <h4>Data Satuan Masih Kosong </h4>
                <a href="<?php echo base_url() ?>gudang/satuan_produk/create" class="btn btn-primary">Tambah Satuan</a>
              <?php } ?>
            <?php }; ?>
          </div><!-- /.page-content -->
        </div>
