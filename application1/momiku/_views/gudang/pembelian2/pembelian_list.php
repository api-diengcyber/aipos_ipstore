            ...
            <div class="row">
              <div class="col-xs-12">
                ...
                <div class="row" style="margin-bottom: 10px">
                    <div class="col-md-4">
                        <?php echo anchor(site_url('gudang/pembelian/create'), 'Pembelian Baru', 'class="btn btn-primary "'); ?>
                    </div>
                      ...
                      <?php $no=1;foreach($data_faktur as $df): ?>
                        <tr>
                          ...
                          <td class="text-center">
                            <a href="<?php echo base_url() ?>gudang/pembelian/read/<?php echo $df->id_faktur ?>" class="btn btn-success btn-xs"><i class="ace-icon fa fa-check"></i></a> 
                            <a href="<?php echo base_url() ?>gudang/pembelian/update/<?php echo $df->id_faktur ?>" class="btn btn-info btn-xs"><i class="ace-icon fa fa-pencil"></i></a>
                          </td>
                        </tr>
                      <?php $no++;endforeach; ?>
                    </tbody>
