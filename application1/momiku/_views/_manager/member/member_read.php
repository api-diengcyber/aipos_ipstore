          ...
          <div class="page-content">
            ...
            <div class="row">
              <div class="col-xs-12">
                ...
                <form action="<?php echo base_url() ?>manager/member_retail/proses_orders" method="post">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><?php echo $no ?></td>
                        <td style="padding:7px 7px 0px 0px;"><?php if ($key->acc_manager!=1 && $key->selesai!=1 || $key->selesai==2) { ?><div style="margin:0px;" class="checkbox"><label><input name="orders_sales[]" type="checkbox" class="ace" id="list" value="<?php echo $key->id_orders_temp ?>" /><span class="lbl"></span></label></div><?php } ?><?php echo $faktur ?></td>
