        ...
        <div class="navbar-header pull-left">
          <a href="" class="navbar-brand">
            <small>
              ...
              &nbsp;&nbsp;<?php echo !empty($nama_toko) ? $nama_toko." (DIREKTUR)" : "Nama Toko" ?>
            </small>
          </a>
        </div>
              ...
              <ul class="dropdown-menu-right dropdown-navbar navbar-green dropdown-menu dropdown-caret dropdown-close">
                ...
                <li class="dropdown-content">
                  <ul class="dropdown-menu dropdown-navbar navbar-green">
                    <li>
                      <a href="#">
                        <button type="button" class="btn btn-xs btn-block btn-primary" onclick="popup('https://m.me/aiposretailrestaurant');">
