                    ...
                    <div class="list-users">
                      <div class="row">
                        ...
                        <div class="col-xs-2" style="padding-left:0px;">
                          ...
                          <?php if (!empty($key->jam_masuk)&&$key->tidak_masuk==0) { echo $key->jam_masuk; } ?>
                          </div>
                        </div>
                        <div class="col-xs-2" style="padding-left:0px;">
                          ...
                          <?php if (!empty($key->jam_pulang)&&$key->tidak_masuk==0) { echo date('H:i:s'); } ?>
                          </div>
                        </div>
                        <div class="col-xs-2" style="padding-left:0px;">
                          <div class="form-group">
                            <select class="select-tidak-masuk" data-id="<?php echo $key->id_users ?>" data-action="tidak_masuk" style="width:100%;">
                        ...
                        <div class="col-xs-4" style="padding-left:0px;">
                          <div class="form-group">
                            <input type="text" class="form-control keterangan" placeholder="Keterangan" value="<?php echo $key->keterangan ?>" data-id="<?php echo $key->id_users ?>" data-action="keterangan">
                          </div>
                        </div>
                      </div>
                    </div>
  ...
  $(".btn-masuk").on("click", function(e){
    ...
    onSubmit(id, act, function(res){
      if (res.status=="ok") {
        ...
        $('.sbox-masuk[data-id="'+id+'"]').text(res.jam);
      }
    });
  });
  $(".btn-pulang").on("click", function(e){
    ...
    onSubmit(id, act, function(res){
      if (res.status=="ok") {
        ...
        $('.sbox-pulang[data-id="'+id+'"]').text(res.jam);
      }
    });
  });
