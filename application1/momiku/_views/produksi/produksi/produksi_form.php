                            ...
                            <div class="row">
                              <div class="col-md-6">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name="pengupasan_mulai" id="pengupasan_mulai" />
                                </div>
                              </div>
                              <div class="col-md-6">
                                <div class="form-group">
                                  <label>Selesai <?php echo form_error('pengupasan_selesai') ?></label>
                                  <input type="text" class="form-control" name="pengupasan_selesai" id="pengupasan_selesai" />
                                </div>
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name="pengepresan_mulai" id="pengepresan_mulai" />
                                </div>
                              </div>
                              <div class="col-md-6">
                                <div class="form-group">
                                  <label>Selesai <?php echo form_error('pengepresan_selesai') ?></label>
                                  <input type="text" class="form-control" name="pengepresan_selesai" id="pengepresan_selesai" />
                                </div>
                              </div>
                            </div>
                          </div>
      ...
      <script type="text/javascript">
        $(document).ready(function(){
          ...
          function addTemp(barcode) {
            ...
            $.ajax({
              url: '<?php echo base_url() ?>produksi/produksi/tambah_temp',
              type: 'post',
          ...
          function listTemp() {
            ...
            $.ajax({
              url: '<?php echo base_url() ?>produksi/produksi/list_temp',
              type: 'get',
              success: function(response){
          ...
          function jqueryTemp() {
            ...
            function updateTemp(id, data) {
              ...
              $.ajax({
                url: '<?php echo base_url() ?>produksi/produksi/update_temp',
                type: 'post',
                data: 'id='+id+'&'+data,
                success: function(response){
                  listTemp();
            ...
            $(".btn-hapus-temp").on("click", function(e){
              ...
              $.ajax({
                url: '<?php echo base_url() ?>produksi/produksi/hapus_temp',
                type: 'post',
                data: 'id='+id,
                success: function(response) {
                  listTemp();
