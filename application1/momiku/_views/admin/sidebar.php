      ...
      <div id="sidebar" class="sidebar responsive ace-save-state sidebar-fixed">
        ...
        <ul class="nav nav-list">
          ...
          <li class="<?php if(isset($active_penjualan_create) || isset($active_order_sales) || isset($active_order_sales_diterima) || isset($active_penjualan_sales) || isset($active_retur_penjualan_create) || isset($active_retur_penjualan_manual_create)){ echo 'active open';}; ?> highlight">
            ...
            <ul class="submenu">
              <li class="<?php if(isset($active_order_sales)){ echo $active_order_sales;}; ?> highlight">
                <a id="bOrderSales" href="<?php echo base_url() ?>admin/order_sales">
                  <i class="menu-icon fa fa-shopping-cart"></i>
              ...
              <li class="<?php if(isset($active_order_sales_diterima)){ echo $active_order_sales_diterima;}; ?> highlight">
                <a id="bOrderSales" href="<?php echo base_url() ?>admin/order_sales/diterima">
                  <i class="menu-icon fa fa-shopping-cart"></i>
