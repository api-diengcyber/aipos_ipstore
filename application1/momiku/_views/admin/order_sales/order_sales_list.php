                          ...
                          <?php 
                            ...
                            if($order_sales->id_status == 1){
                                foreach($exp as $item){
                                    ...
                                    echo "<a href='".base_url('admin/order_sales/update_expedisi/'.$order_sales->id_order.'/'.$item->id)."' class='btn ".$btn."' style='margin-right:3px;margin-bottom:3px'>".$item->nama_expedisi.'</a>';
                                }
                            } ?>
                            <hr>
