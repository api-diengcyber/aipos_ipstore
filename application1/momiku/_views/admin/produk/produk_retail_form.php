            ...
            <div class="row">
              <div class="col-md-6">
                <!-- PAGE CONTENT BEGINS -->
                    ...
                    <div class="form-group">
                        <label for="int">Harga 1 <?php echo form_error('harga_1') ?></label>
              ...
              <div class="col-md-6">
                    <div class="form-group">
                        <label for="int">Harga 2 <?php echo form_error('harga_2') ?></label>
                    ...
                    <div class="form-group">
                        <label for="int">Harga 3 <?php echo form_error('harga_3') ?></label>
