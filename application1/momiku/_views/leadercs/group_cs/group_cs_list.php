                ...
                <div class="col-xs-12">
                    <div class="row" style="margin-bottom: 10px">
                        ...
                        <div class="col-md-4 text-right">
                            <?php echo anchor(site_url('leadercs/group_cs/create'), 'Create', 'class="btn btn-primary"'); ?>
                    <?php echo anchor(site_url('leadercs/group_cs/excel'), 'Excel', 'class="btn btn-primary"'); ?>
                    </div>
                    </div>
                    ...
                    <script type="text/javascript">
                        $(document).ready(function() {
                            ...
                            var t = $("#mytable").dataTable({
                                ...
                                processing: true,
                                serverSide: true,
                                ajax: {"url": "group_cs/json", "type": "POST"},
                                columns: [
                                    {
                                        "data": "id",
                                        "orderable": false
