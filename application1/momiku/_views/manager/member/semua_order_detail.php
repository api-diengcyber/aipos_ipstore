          ...
          <div class="page-content">
            ...
            <div class="row">
              <div class="col-xs-12">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-10">
                      <select name="jenis" class="form-control" onchange="this.form.submit()">
                        ...
                        <option value="1" <?php echo $jenis==1 ? "selected" : "" ?>>Belum diproses manager</option>
                        <option value="2" <?php echo $jenis==2 ? "selected" : "" ?>>Diproses manager</option>
                ...
                <a href="<?php echo base_url() ?>manager/member_retail/semua_order" class="btn btn-primary">Kembali</a>
              </div>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.page-content -->
