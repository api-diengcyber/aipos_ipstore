          ...
          <div class="page-content">
            ...
            <div class="row">
              <div class="col-xs-12">
                ...
                <a href="<?php echo base_url() ?>manager/member_retail/order_sales_action/<?php echo $id_member ?>" class="btn btn-primary pull-right" style="margin-bottom:20px"><i class="fa fa-shopping-cart"></i> Order</a>
              </div>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.page-content -->
    ...
    <script>
      $(document).ready(function(){
        ...
        $('#select2').on('select2:select', function (e) {
          ...
          var id = data.id;
          ajax('<?php echo base_url() ?>manager/member_retail/json_input_sales_temp', "id_produk_2="+id+"&id_member=<?php echo $id_member ?>", function(response){
        ...
        function loadTemp() {
          ...
          ajax('<?php echo base_url() ?>manager/member_retail/json_sales_temp', "id_member=<?php echo $id_member ?>", function(data){
            var html = "";
            var no = 1;
            var total_qty = 0;
            for (var item in data) {
              ...
              <tr>\
                ...
                <td width='150'><button type='button' data-id='"+data[item].id_produk+"' data-stok='"+data[item].stok+"' class='btn btn-primary btn-xs no-border btn-edit'>Simpan</button> <a href='<?php echo base_url() ?>manager/member_retail/order_sales_delete/"+data[item].id+"' class='btn btn-danger btn-xs no-border'>Hapus</a></td>\
              </tr>\
              ";
            ...
            $(".btn-edit").click(function(){
              ...
              if (qty > stok) {
                ...
                ajax('<?php echo base_url() ?>manager/member_retail/json_input_sales_temp', "id_produk_2="+id+"&id_member=<?php echo $id_member ?>&qty="+qty, function(response){
                  showAlt(response.msg);
                  loadTemp();
                });
              }
