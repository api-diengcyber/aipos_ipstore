...
class Pegawai_retail extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->view->render_produksi('pegawai/users_list', $data);
    } 
    
    public function json() {
        header('Content-Type: application/json');
        echo $this->Pegawai_retail_model->json_sales_produksi($this->userdata->id_toko);
    }
    ...
    public function read($id) 
    {
        ...
        if ($row) {
            ...
            $this->view->render_produksi('pegawai/users_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('produksi/pegawai_retail'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            ...
            'nama_modul' => $this->userdata->nama_modul,
            'button' => 'Tambah',
            'action' => site_url('produksi/pegawai_retail/create_action'),
            'id' => set_value('id'),
            'id_toko' => $this->userdata->id_toko,
        ...
        $this->view->render_produksi('pegawai/users_form', $data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                ...
                'nama_modul' => $this->userdata->nama_modul,
                'button' => 'Simpan',
                'action' => site_url('produksi/pegawai_retail/update_action'),
