...
class Pegawai_retail extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->view->render_manager('pegawai/users_list', $data);
    } 
    ...
    public function read($id) 
    {
        ...
        if ($row) {
            ...
            $this->view->render_manager('pegawai/users_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('manager/pegawai_retail'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            ...
            'nama_modul' => $this->userdata->nama_modul,
            'button' => 'Tambah',
            'action' => site_url('manager/pegawai_retail/create_action'),
            'id' => set_value('id'),
            'id_toko' => $this->userdata->id_toko,
        ...
        $this->view->render_manager('pegawai/users_form', $data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                ...
                'nama_modul' => $this->userdata->nama_modul,
                'button' => 'Simpan',
                'action' => site_url('manager/pegawai_retail/update_action'),
    ...
    public function delete($id) 
    {
        ...
        if ($row) {
        	if($row->id==$this->userdata->id_user){
            	$this->session->set_flashdata('message', 'Cant Delete manager');
        	} else {
    ...
    public function word()
    {
        ...
        $this->load->view('retail/manager/pegawai/users_doc',$data);
    }
