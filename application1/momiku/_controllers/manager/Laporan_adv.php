...
class Laporan_adv extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->view->render_manager('laporan_adv/laporan_adv_list',$data);
    } 
    ...
    public function read($id) 
    {
        ...
        if ($row) {
            ...
            $this->view->render_manager('laporan_adv/laporan_adv_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->view->render_manager('laporan_adv/laporan_adv_form', $data);
    }
    ...
    public function per_group()
    {
        ...
        $this->view->render_manager('laporan_adv/laporan_per_group', $data);    
    }
    ...
    public function total_per_group(){
        ...
        $this->view->render_manager('laporan_adv/laporan_total_per_group', $data);
    }
    ...
    public function grand_all_team()
    {
        ...
        $this->view->render_manager('laporan_adv/laporan_grand_total', $data, FALSE);
    }
