...
class Kota extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->view->render_outlet('kota/kota_list', $data);
    } 
    ...
    public function read($id) 
    {
        ...
        if ($row) {
            ...
            $this->view->render_outlet('kota/kota_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('outlet/kota'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            ...
            'nama_modul' => $this->userdata->nama_modul,
            'button' => 'Create',
            'action' => site_url('outlet/kota/create_action'),
            'id' => set_value('id'),
            'nama_kota' => set_value('nama_kota'),
        );
        $this->view->render_outlet('kota/kota_form', $data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                ...
                'nama_modul' => $this->userdata->nama_modul,
                'button' => 'Update',
                'action' => site_url('outlet/kota/update_action'),
