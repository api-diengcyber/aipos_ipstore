...
class Piutang_retail extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->view->render_outlet('piutang/piutang_list', $data);
    }
    ...
    public function read($id) 
    {
        ...
        if ($row) {
            ...
            $this->view->render_outlet('piutang/piutang_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('outlet/piutang_retail'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            ...
            'nama_modul' => $this->userdata->nama_modul,
            'button' => 'Tambah',
            'action' => site_url('outlet/piutang_retail/create_action'),
            'id' => set_value('id'),
            'id_toko' => $this->userdata->id_toko,
        ...
        $this->view->render_outlet('piutang/piutang_form', $data);
    }
    ...
    public function update($id)
    {
        ...
        if ($row) {
            $data = array(
                ...
                'nama_modul' => $this->userdata->nama_modul,
                'button' => 'Simpan',
                'action' => site_url('outlet/piutang_retail/update_action'),
    ...
    public function bayar($id)
    {
        ...
        if ($row) {
            $data = array(
                ...
                'nama_modul' => $this->userdata->nama_modul,
                'button' => 'Simpan',
                'action' => site_url('outlet/piutang_retail/bayar_action'),
                'id' => set_value('id', $row->id_piutang),
                'no_faktur' => set_value('no_faktur', $row->no_faktur),
                'id_pembeli' => set_value('id_pembeli', $row->id_pembeli),
                'jumlah_hutang' => set_value('jumlah_hutang', $row->jumlah_hutang),
            ...
            $this->view->render_outlet('piutang/piutang_bayar', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('outlet/piutang_retail'));
        }
    ...
    public function word()
    {
        ...
        $this->load->view('outlet/piutang/piutang_doc',$data);
    }
