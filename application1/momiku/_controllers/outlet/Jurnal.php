...
class Jurnal extends CI_Controller {
	...
	public function index()
	{
		...
		$data['data_jurnal'] = $this->db->select('j.*, a.akun')
										...
										->get()->result();
		if ($print!=true) {
	        $this->view->render_outlet('jurnal2/jurnal_list', $data);
		} else {
			$this->load->view('outlet/jurnal2/jurnal_list', $data, FALSE);
		}
	}
	...
	public function create()
	{
		$data = array(
            ...
            'id_modul' => $this->userdata->id_modul,
            'nama_modul' => $this->userdata->nama_modul,
			'action' => site_url('outlet/jurnal/create_action'),
        ...
        $this->view->render_outlet('jurnal2/jurnal_form', $data);
	}
	...
	public function create_action()
	{
        ...
        if ($this->form_validation->run() == FALSE) {
        	...
        	redirect(site_url('outlet/jurnal/create'));
        }
	}
    ...
    public function delete($id) 
    {
        ...
        if ($row) {
            ...
            redirect(site_url('outlet/jurnal'));
        } else {
