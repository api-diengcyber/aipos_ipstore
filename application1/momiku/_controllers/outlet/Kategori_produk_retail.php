...
class Kategori_produk_retail extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->view->render_outlet('kategori_produk/kategori_produk_list', $data);
    } 
    ...
    public function read($id) 
    {
        ...
        if ($row) {
            ...
            $this->view->render_outlet('kategori_produk/kategori_produk_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('outlet/kategori_produk_retail'));
        }
    }
    ...
    public function create() 
    {
        ...
        $data = array(
            ...
            'nama_modul' => $this->userdata->nama_modul,
            'button' => 'Tambah',
            'action' => site_url('outlet/kategori_produk_retail/create_action'),
        ...
        $this->view->render_outlet('kategori_produk/kategori_produk_form', $data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                ...
                'nama_modul' => $this->userdata->nama_modul,
                'button' => 'Simpan',
                'action' => site_url('outlet/kategori_produk_retail/update_action'),
