...
class Laporan_pembelian extends CI_Controller {
	...
	public function rinci_supplier()
	{
		...
		$data['data_faktur'] = $this->db->select('fr.*')
									   ...
									   ->get()->result();
		if ($print!="true") {
	        $this->view->render_direktur('laporan_baru/pembelian_rinci_per_supplier', $data);
		} else {
			$this->load->view('direktur/laporan_baru/pembelian_rinci_per_supplier', $data);
		}
	}
	...
	public function rekap_supplier()
	{
		...
		$data['data_faktur'] = $this->db->select('fr.*')
									   ...
									   ->get()->result();
		if ($print!="true") {
	        $this->view->render_direktur('laporan_baru/pembelian_rekap_per_supplier', $data);
		} else {
			$this->load->view('direktur/laporan_baru/pembelian_rekap_per_supplier', $data);
		}
	}
	...
	public function rinci()
	{
		...
		$data['data_faktur'] = $this->db->select('fr.*, s.nama_supplier')
									   ...
									   ->get()->result();
		if ($print!="true") {
	        $this->view->render_direktur('laporan_baru/pembelian_rinci_supplier', $data);
		} else {
			$this->load->view('direktur/laporan_baru/pembelian_rinci_supplier', $data);
		}
	}
	...
	public function rekap()
	{
		...
		$data['data_faktur'] = $this->db->select('fr.*, s.nama_supplier')
									   ...
									   ->get()->result();
		if ($print!="true") {
	        $this->view->render_direktur('laporan_baru/pembelian_rekap_supplier', $data);
		} else {
			$this->load->view('direktur/laporan_baru/pembelian_rekap_supplier', $data);
		}
	}
