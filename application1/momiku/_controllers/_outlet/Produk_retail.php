...
class Produk_retail extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->view->render_outlet('produk/produk_retail_list', $data);
    }
    ...
    public function read($id) 
    {
        ...
        if ($row) {
	        ...
	        $this->view->render_outlet('produk/produk_retail_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('outlet/retail'));
        }
    }
    ...
    public function create($bar = NULL)
    {
        ...
        $data = array(
            ...
            'nama_modul' => $this->userdata->nama_modul,
            'button' => 'Tambah',
            'action' => site_url('outlet/produk_retail/create_action'),
        ...
        $this->view->render_outlet('produk/produk_retail_form', $data);
    }
    ...
    public function create_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
		    ...
		    /* faktur */
	    	$row_faktur = $this->db->where('id_toko', $this->userdata->id_toko)->order_by('id_faktur', 'desc')->get('faktur_retail')->row();
	    	$id_faktur = "";
	    	if($row_faktur){
	    		// jika ada faktur //
            ...
            redirect(site_url('outlet/produk_retail'));
        }
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
	        ...
	        $data = array(
	            ...
	            'nama_modul' => $this->userdata->nama_modul,
                'button' => 'Simpan',
                'action' => site_url('outlet/produk_retail/update_action'),
    ...
    public function delete($id) 
    {
        ...
        if ($row) {
        	...
        	$this->db->where('id_produk', $row->id_produk_2);
        	$this->db->delete('stok_produk');
        	$this->db->where('id_toko', $this->userdata->id_toko);
        	$this->db->where('id_produk', $row->id_produk_2);
        	$this->db->delete('pembelian');
        	$this->db->where('id_toko', $this->userdata->id_toko);
        	$this->db->where('id_produk_2', $row->id_produk_2);
        	$this->db->delete('produk_retail');
    ...
    public function word()
    {
        ...
        $this->load->view('outlet/produk/produk_retail_doc',$data);
    }
    ...
    public function cetak_label_barcode()
    {
		...
		$this->load->view('outlet/produk/cetak_label_barcode', $data);
    }
    ...
    public function edit_semua()
    {
        ...
        $this->view->render_outlet('produk/edit_semua', $data);
    }
