...
class Supplier_retail extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->view->render_outlet('supplier/supplier_list', $data);
    }
    ...
    public function read($id) 
    {
        ...
        if ($row) {
            ...
            $this->view->render_outlet('supplier/supplier_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('outlet/supplier'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            ...
            'nama_modul' => $this->userdata->nama_modul,
            'button' => 'Tambah',
            'action' => site_url('outlet/supplier_retail/create_action'),
        ...
        $this->view->render_outlet('supplier/supplier_form', $data);
    ...
    public function create_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect(site_url('outlet/supplier_retail'));
        }
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                ...
                'nama_modul' => $this->userdata->nama_modul,
                'button' => 'Simpan',
                'action' => site_url('outlet/supplier_retail/update_action'),
    ...
    public function word()
    {
        ...
        $this->load->view('outlet/supplier/supplier_doc',$data);
    }
