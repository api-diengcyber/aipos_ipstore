...
class Penjualan_retail extends CI_Controller
{
    ...
    public function index()
    {
      ...
      $this->view->render_admin('penjualan/orders_list', $data);
    }
    ...
    public function read($id)
    {
        ...
        if ($row) {
            ...
            $this->view->render_admin('penjualan/orders_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->view->render_admin('penjualan/form_penjualan', $data);
    }
...
//          'ppn' => 10,
    ...
    public function detail_faktur($faktur="")
    {
        ...
        $this->view->render_admin('penjualan/detail_faktur', $data);
    }
    ...
    public function cetak_nota_penjualan($faktur="", $bayar = 0, $print = 1)
    {
        ...
        if($this->userdata){
            $res_orders_detail = $this->db->select("od.*, pr.barcode, pr.nama_produk, pr.harga_1, pr.harga_2, pr.harga_3, pr.diskon AS diskon_produk, pr.mingros, sp.satuan")
                                            ...
                                            ->join("satuan_produk sp", "pr.satuan=sp.id_satuan AND sp.id_toko = '".$this->userdata->id_toko."'")
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            ...
            $this->view->render_admin('penjualan/orders_form_update', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('admin/penjualan_retail'));
        }
    ...
    public function insert_barang_temp_by_id($tgl='')
    {
        ...
        $id_pil_harga = ($this->input->post('id_pil_harga', true))?$this->input->post('id_pil_harga', true):0;
    ...
    public function orders_sales_group()
    {
        ...
        $this->view->render_admin('penjualan/orders_sales_group', $data);
    }
    ...
    public function orders_sales($id = '')
    {
        ...
        $this->view->render_admin('penjualan/orders_sales', $data);
    }
