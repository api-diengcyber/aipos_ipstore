...
class Piutang_retail extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->view->render_admin('piutang/piutang_list', $data);
    }
    ...
    public function read($id) 
    {
        ...
        if ($row) {
            ...
            $this->view->render_admin('piutang/piutang_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->view->render_admin('piutang/piutang_form', $data);
    }
    ...
    public function bayar($id)
    {
        ...
        if ($row) {
            ...
            $this->view->render_admin('piutang/piutang_bayar', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('admin/piutang_retail'));
        }
