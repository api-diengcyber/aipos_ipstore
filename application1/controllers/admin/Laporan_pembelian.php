...
class Laporan_pembelian extends AI_Admin {
	...
	public function rinci_supplier()
	{
		...
		$data['data_faktur'] = $this->db->select('fr.*')
									   ...
									   ->get()->result();
		if ($print!="true") {
	        $this->view('laporan_baru/pembelian_rinci_per_supplier', $data);
		} else {
	...
	public function rekap_supplier()
	{
		...
		$data['data_faktur'] = $this->db->select('fr.*')
									   ...
									   ->get()->result();
		if ($print!="true") {
	        $this->view('laporan_baru/pembelian_rekap_per_supplier', $data);
		} else {
	...
	public function rinci()
	{
		...
		$data['data_faktur'] = $this->db->select('fr.*, s.nama_supplier')
									   ...
									   ->get()->result();
		if ($print!="true") {
	        $this->view('laporan_baru/pembelian_rinci_supplier', $data);
		} else {
	...
	public function rekap()
	{
		...
		$data['data_faktur'] = $this->db->select('fr.*, s.nama_supplier')
									   ...
									   ->get()->result();
		if ($print!="true") {
	        $this->view('laporan_baru/pembelian_rekap_supplier', $data);
		} else {
