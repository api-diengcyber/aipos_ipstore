...
class Kategori_produk_retail extends AI_Admin
{
    function __construct()
    {
        parent::__construct();
        $this->models('Kategori_produk_retail_model');
    }
    ...
    public function index()
    {
        ...
        $this->view('kategori_produk/kategori_produk_list', $data);
    } 
    ...
    public function read($id) 
    {
        ...
        if ($row) {
            ...
            $this->view('kategori_produk/kategori_produk_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('admin/kategori_produk_retail'));
        }
    }
    ...
    public function create() 
    {
        ...
        $data = array(
            'active_kategori_produk' => 'active',
            'button' => 'Tambah',
            'action' => site_url('admin/kategori_produk_retail/create_action'),
        ...
        $this->view('kategori_produk/kategori_produk_form', $data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'active_kategori_produk' => 'active',
                'button' => 'Simpan',
                'action' => site_url('admin/kategori_produk_retail/update_action'),
