...
class Laporan_persediaan extends AI_Admin {
	...
	public function index()
	{
		...
		$data['method'] = $this;
		if ($print!="true") {
			$this->view('laporan_baru/persediaan', $data);
		} else {
	...
	public function harian()
	{
		...
		$data['data_produk'] = $this->db->select('pr.*, sp.satuan AS nama_satuan')
																		...
																		->get()->result();
		if ($print!="true") {
			$this->view('laporan_baru/persediaan_harian', $data);
		} else {
			$this->load->view('admin/laporan_baru/persediaan_harian', $data);
		}
	}
	...
	public function mutasi()
	{
		...
		$data['data_produk'] = $this->db->select('pr.*, sp.satuan AS nama_satuan')
																		...
																		->get()->result();
		if ($print!="true") {
			$this->view('laporan_baru/mutasi_stok_harian', $data);
		} else {
			$this->load->view('admin/laporan_baru/mutasi_stok_harian', $data);
		}
	}
