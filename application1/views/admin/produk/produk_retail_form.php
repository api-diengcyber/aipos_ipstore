              ...
              <div class="col-md-6">
                <!-- PAGE CONTENT BEGINS -->
                    ...
                    <div class="form-group">
                      <?php 
                      if($parent==null){?>
                        <label for="bigint">Barcode <?php echo form_error('barcode') ?>
                      ...
                      <?php
                            ...
                            <label for="bigint">Barcode <?php echo form_error('barcode') ?></label> 
                            <input type="text" class="form-control" name="barcode" id="barcode" placeholder="Barcode" value="<?php echo $parent->barcode; ?>" />
                      <?php                        
                        }
                      ?>                       
