          ...
          <div class="page-content">
            ...
            <div class="row">
              <div class="col-xs-12">
                ...
                <div class="row" style="margin-bottom: 10px">
                  ...
                  <div class="col-md-3">
                    <select multiple="" class="chosen-select form-control" data-placeholder="Pilih Kolom">
                      ...
                      <option value="5">H. Jual</option>
                      <option value="6">H. Grosir</option>
                      <option value="7">H. Member</option>
                      <!-- <option value="8">H. 4</option>
                      <option value="9">H. 5</option>
                      <option value="10">H. 6</option> -->
                      <option value="11">H. Beli</option>
                    </select>
                  </div>
                ...
                <a href="<?php echo base_url() ?>admin/produk_retail" class="btn btn-default"><< Kembali</a>
...
<?php 
  ...
  function loadData(data) {
    $.ajax({
      url: '<?php echo base_url() ?>admin/produk_retail/json',
      type: 'get',
  ...
  function saveData(data, result) {
    $.ajax({
      url: '<?php echo base_url() ?>admin/produk_retail/simpan_semua_produk',
      type: 'post',
