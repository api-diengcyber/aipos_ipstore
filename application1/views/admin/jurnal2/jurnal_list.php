                ...
                ?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9">
                              <div class="pos-rel">
                                  ...
                                  <input class="form-control" type="text" name="periode" id="id-date-range-picker-1" value="0" autocomplete="off" />
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="table-responsive">
                      ...
                      <table id="mytable" class="table table-striped table-bordered table-hover">
                        ...
                        $sub_debet += $key->debet;
                        $sub_kredit += $key->kredit;
                          if ($show_kode && $no < 0) { ?>
                          <tr>
                              <td colspan="5">Subtotal</td>
                              <td><?php echo number_format($sub_debet,0,',','.') ?></td>
                        ...
                        ?>
                          <tr>
                            ...
                            <?php if ($show_kode) { ?><td rowspan="<?php echo $jml_sub ?>"><?php echo $key->kode ?><br><a href="<?php echo base_url() ?>admin/jurnal/update/<?php echo str_replace(' ','',$key->kode) ?>" class="btn btn-primary btn-xs">Edit</a>&nbsp;&nbsp;<a href="#" class="btn btn-danger btn-xs btn-delete-all" data-kode="<?php echo str_replace(" ","",$key->kode) ?>" data-id="<?php echo str_replace(" ","",$key->id) ?>">Hapus</a></td><?php } ?>
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <form method="post" action="<?php echo base_url() ?>admin/jurnal/konfirmasi_delete">
        <div class="modal-body">
          <div class="form-group">
            <input type="hidden" name="kode" id="input-kode">
        ...
        <div class="modal-footer">
          <button type="submit" class="btn btn-primary">Proses Hapus</button>
