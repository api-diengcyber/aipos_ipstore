                ...
                <form action="<?php echo $action ?>" method="post">
                  ...
                  <div class="row">
                    <div class="col-xs-12">
                      ...
                      <div id="notif" class="alert alert-warning" style="display:none;"></div>   
...
$(document).ready(function(){
  ...
  function totalFunction() {
    ...
    if (s_balance > 0) {
        $("#notif").show();
        $("#notif").html("Debet (D) lebih besar dari kredit");
    }
    if (s_balance < 0) {
        $("#notif").show();
        $("#notif").html("Kredit (K) lebih besar dari debet");
    }
  }
});
</script>