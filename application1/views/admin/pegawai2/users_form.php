...
<!--                         
                    ...
                    <div class="form-group">
                        <label for="varchar">Beban Per <?php echo form_error('beban_per') ?></label>
                        <input type="text" class="form-control" name="beban_per" id="beban per" placeholder="Beban Per" value="<?php echo $beban_per; ?>"/>
                    </div>
                    <div class="form-group">
