        ...
        <div class="main-content-inner">
          <div class="breadcrumbs ace-save-state breadcrumbs-fixed" id="breadcrumbs">
            <ul class="breadcrumb">
              ...
              <li class="active">Edit Pembelian Barang</li>
            </ul><!-- /.breadcrumb -->
          ...
          <div class="page-content">
            ...
            <div class="row">
              <div class="col-xs-12">
                ...
                <form action="<?php echo base_url() ?>admin/pembelian/update_action" method="post">
                      ...
                      <div class="row">
                        <div class="col-xs-2" style="padding-right:0px;">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="nofaktur" id="nofaktur" placeholder="No Faktur" value="<?php echo $no_faktur ?>" disabled>
                            <input type="hidden" name="id_faktur" id="id_faktur" value="<?php echo $id_faktur ?>">
                          </div>
                        </div>
                        <div class="col-xs-2">
                          <div class="form-group">
                            <label>Tanggal Masuk <?php echo form_error('tgl') ?></label>
                            <input type="text" class="form-control" name="tgl" id="tgl" placeholder="dd-mm-yyyy" value="<?php echo $tgl ?>" disabled>
                          </div>
                        </div>
                      <!-- </div>
                      <div class="row"> -->
                        <div class="col-xs-2">
                          <div class="form-group">
                            ...
                            <?php foreach ($data_supplier as $key): ?>
                              <option value="<?php echo $key->id_supplier ?>" <?php echo $supplier==$key->id_supplier ? "selected" : "" ?>><?php echo $key->nama_supplier ?></option>
                            <?php endforeach ?>
                            </select>
                          </div>
                        </div>
                        <div class="col-xs-2">
                          <div class="row">
                            <div class="col-xs-12">
                              ...
                              <div class="form-group">
                                <select class="form-control" name="pembayaran" id="pembayaran" disabled>
                                  <option value="0" <?php echo $pembayaran==0 ? "selected" : "" ?>>TUNAI</option>
                                  <option value="1" <?php echo $pembayaran==1 ? "selected" : "" ?>>HUTANG / KREDIT</option>
                                </select>
                              </div>
                            </div>
                            <div class="col-xs-12" id="panel-jatuh-tempo" style="display: none;">
                              <div class="form-group">
                                <input type="text" class="form-control" name="jatuh_tempo" id="datepicker2" placeholder="dd-mm-yyyy" value="<?php echo $deadline ?>" disabled>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div class="col-xs-2">
                          <div class="form-group">
                            ...
                            foreach ($data_bank as $key): ?>
                              <option value="<?php echo $key->id ?>" <?php echo $key->id==$id_bank ? "selected" : "" ?>><?php echo $key->bank ?></option>
                            <?php endforeach ?>
                            </select>
                          </div>
                        </div>
      ...
      <script type="text/javascript">
        $(document).ready(function(){
          ...
          function addTemp(barcode) {
            ...
            $.ajax({
              url: '<?php echo base_url() ?>admin/pembelian/tambah_temp_update',
              type: 'post',
              data: 'barcode='+barcode+'&id_faktur=<?php echo $id_faktur*1 ?>',
          ...
          function listTemp() {
            ...
            $.ajax({
              url: '<?php echo base_url() ?>admin/pembelian/list_temp_update/<?php echo $id_faktur ?>',
              type: 'get',
              success: function(response){
          ...
          function jqueryTemp() {
            ...
            function updateTemp(id, data) {
              ...
              $.ajax({
                url: '<?php echo base_url() ?>admin/pembelian/update_temp_update',
                type: 'post',
                data: 'id='+id+'&'+data,
                success: function(response){
            ...
            $(".btn-hapus-temp").on("click", function(e){
              ...
              $.ajax({
                url: '<?php echo base_url() ?>admin/pembelian/hapus_temp_update',
                type: 'post',
                data: 'id='+id,
                success: function(response) {
                  listTemp();
