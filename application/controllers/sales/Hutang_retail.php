...
class Hutang_retail extends AI_Admin
{
    function __construct()
    {
        parent::__construct();
        $this->models('Hutang_retail_model');
    }
    ...
    public function index()
    {
        ...
        $this->view('hutang/hutang_list', $data);
    } 
    ...
    public function read($id) 
    {
        ...
        if ($row) {
            ...
            $this->view('hutang/hutang_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->view('hutang/hutang_form', $data);
    }
