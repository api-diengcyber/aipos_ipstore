...
class Pegawai_retail extends AI_Admin
{
    ...
    public function index()
    {
        ...
        $this->view('pegawai/users_list', $data);
    } 
    ...
    public function read($id) 
    {
        ...
        if ($row) {
            ...
            $this->view('pegawai/users_read', $data);
        } else {
    ...
    public function create() 
    {
        $data = array(
            ...
            'nama_modul' => $this->userdata->nama_modul,
            'button' => 'Tambah',
            'action' => site_url('admin/pegawai_retail/create_action'),
            'id' => set_value('id'),
            'id_toko' => $this->userdata->id_toko,
        ...
        $this->view('pegawai/users_form', $data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                ...
                'nama_modul' => $this->userdata->nama_modul,
                'button' => 'Simpan',
                'action' => site_url('admin/pegawai_retail/update_action'),
