...
class Akun_retail extends AI_Admin
{
    function __construct()
    {
        parent::__construct();
        $this->models('Akun_retail_model');
    }
    ...
    public function create_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if (substr($kode_parent, 0, 10) == "1.01.03.01") {
                $data['parent'] = 'bank';
            }
