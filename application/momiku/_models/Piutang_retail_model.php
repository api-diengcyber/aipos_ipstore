...
class Piutang_retail_model extends CI_Model
{
    ...
    function json($id_toko) {
        ...
        $this->datatables->add_column('action', anchor(site_url('admin/piutang_retail/read/$1'),'<button class="btn btn-xs btn-success">Lihat</button>')."&nbsp;".anchor(site_url('admin/piutang_retail/bayar/$1'),'<button class="btn btn-xs btn-primary">Bayar</button>')."&nbsp;".anchor(site_url('admin/piutang_retail/delete/$1'),'<button class="btn btn-xs btn-danger">Hapus</button>','onclick="javasciprt:return confirm(\'Are You Sure ?\')"'), 'id_piutang');
