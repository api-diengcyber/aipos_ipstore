...
class Hutang_retail_model extends CI_Model
{
    ...
    function json() {
        ...
        $this->datatables->join("faktur_retail fr", "h.id_faktur=fr.id_faktur AND fr.id_toko=h.id_toko", "left");
        $this->datatables->join("supplier s", "h.id_supplier=s.id_supplier AND h.id_toko=s.id_toko", "left");
    ...
    function get_all_hutang() {
        ...
        $this->db->join('supplier s','s.id_supplier=h.id_supplier AND s.id_toko=h.id_toko');
    ...
    function get_by_between_date($id_toko, $tgl1='', $tgl2='')
    {
        ...
        $this->db->from("hutang h");
        $this->db->join("users u" ,"h.id_users=u.id_users AND h.id_toko=u.id_toko");
        $this->db->join("faktur_retail fr", "h.id_faktur=fr.id_faktur AND fr.id_toko=h.id_toko", "left");
        $this->db->join("supplier s", "h.id_supplier=s.id_supplier AND h.id_toko=s.id_toko", "left");
