...
class Pembelian_retail_model extends CI_Model
{
    ...
    function json($id_toko) {
        ...
        $this->datatables->join('users u', 'p.id_users=u.id_users AND p.id_toko=u.id_toko','left');
        $this->datatables->join('produk_retail pr', 'p.id_produk = pr.id_produk_2 AND pr.id_toko=p.id_toko');
    ...
    function json_by_expire($id_toko, $tgl_expire)
    {
        ...
        $this->datatables->join('users u', 'pembelian.id_users=u.id_users AND pembelian.id_toko=u.id_toko','left');
        $this->datatables->join('produk_retail', 'pembelian.id_produk=produk_retail.id_produk_2 AND produk_retail.id_toko=pembelian.id_toko');
        $this->datatables->join('supplier', 'pembelian.id_supplier=supplier.id_supplier AND supplier.id_toko=pembelian.id_toko');
        $this->datatables->join('faktur_retail', 'pembelian.id_faktur=faktur_retail.id_faktur AND faktur_retail.id_toko=pembelian.id_toko');
    ...
    function get_by_search($id_toko, $term, $tgl)
    {
        ...
        $this->db->join('users u', 'pembelian.id_users=u.id_users AND pembelian.id_toko=u.id_toko','left');
        $this->db->join('produk_retail', 'pembelian.id_produk=produk_retail.id_produk_2 AND produk_retail.id_toko=pembelian.id_toko');
        $this->db->join('supplier', 'pembelian.id_supplier=supplier.id_supplier AND supplier.id_toko=pembelian.id_toko', 'left');
        $this->db->join('faktur_retail', 'pembelian.id_faktur=faktur_retail.id_faktur AND faktur_retail.id_toko=pembelian.id_toko');
    ...
    function get_by_id_toko($id_toko)
    {
        ...
        $this->db->join('produk_retail AS pr', 'p.id_produk=pr.id_produk_2 AND pr.id_toko=p.id_toko');
        $this->db->join('faktur_retail as fr', 'p.id_faktur = fr.id_faktur AND fr.id_toko=p.id_toko');
    ...
    function get_by_id_produk($id_produk, $id_toko)
    {
        ...
        $this->db->from('pembelian AS p');
        $this->db->join('stok_produk', 'p.id_pembelian = stok_produk.id_pembelian AND stok_produk.id_toko=p.id_toko', "left");
    ...
    {
        $this->db->select('p.*, stok_produk.stok');
        $this->db->from('pembelian AS p');
        $this->db->join('stok_produk', 'p.id_pembelian = stok_produk.id_pembelian AND stok_produk.id_toko=p.id_toko');
        $this->db->where('p.id_produk', $id_produk);
        $this->db->where('p.id_toko', $this->userdata->id_toko);
        ...
        $this->db->order_by('p.id_pembelian', 'ASC');
        // FIFO //
        $this->db->group_by('stok_produk.id');
        return $this->db->get()->result();
    }
    ...
    function get_by_tgl_expire($tgl_expire, $id_toko , $limit = '')
    {
        ...
        $this->db->join('faktur_retail f', 'p.id_faktur=f.id_faktur and f.id_toko=p.id_toko');
        $this->db->join('produk_retail as pr', 'pr.id_produk_2 = p.id_produk and pr.id_toko=p.id_toko');
        $this->db->join('supplier as s', 's.id_supplier = p.id_supplier and s.id_toko=p.id_toko');
    ...
    {
        $this->db->where('id_toko', $this->userdata->id_toko);
        $this->db->where($this->id_faktur, $id_faktur);
        return $this->db->get($this->table)->result();
    }
    ...
    function get_by_between_date($id_toko, $tgl1='', $tgl2='')
    {
        ...
        $this->db->from('pembelian AS p');
        $this->db->join('produk_retail AS pr', 'p.id_produk = pr.id_produk_2 AND pr.id_toko=p.id_toko');
        $this->db->join('supplier', 'p.id_supplier=supplier.id_supplier AND supplier.id_toko=p.id_toko');
        $this->db->where('p.id_toko', $this->userdata->id_toko);
