                  ...
                  <div class="col-sm-5">
                    ...
                    <div class="infobox infobox-green infobox-large infobox-dark" style="width:49.4%!important;margin-bottom:2px">
                      ...
                      <div class="infobox-data">
                        ...
                        ?>
                        <div class="infobox-content" style="margin-top:-10px;"><<?php echo $heading ?>>Rp.<?php echo number_format($laba_hari_ini->jml_laba,0,',','.'); ?> 
                          <!-- (Netto) <br>Rp.<?php echo number_format(($laba_hari_ini->jml_laba*(10/100))+$laba_hari_ini->jml_laba,0,',','.'); ?> (PPn)</<?php echo $heading ?>> -->
                        </div>
                      </div>
                    </div>
                    <div class="infobox infobox-blue infobox-large infobox-dark" style="width:49.4%!important;margin-bottom:2px">
                      ...
                      <div class="infobox-data">
                        ...
                        ?>
                        <div class="infobox-content" style="margin-top:-10px;"><<?php echo $heading ?>>Rp.<?php echo number_format($laba_bulan_ini->jml_laba,0,',','.'); ?> 
                          <!-- (Netto) <br>Rp.<?php echo number_format(($laba_bulan_ini->jml_laba*(10/100))+$laba_bulan_ini->jml_laba,0,',','.'); ?> (PPn)</<?php echo $heading ?>> -->
                        </div>
                      </div>
                    </div>
                    <div class="infobox infobox-grey infobox-large infobox-dark" style="width:49.4%!important;margin-bottom:2px">
                      ...
                      <div class="infobox-data">
                        ...
                        ?>
                        <div class="infobox-content" style="margin-top:-10px;"><<?php echo $heading ?>>Rp.<?php echo number_format($laba_total->jml_laba,0,',','.'); ?> 
                          <!-- (Netto) <br>Rp.<?php echo number_format(($laba_total->jml_laba*(10/100))+$laba_total->jml_laba,0,',','.'); ?> (PPn)</<?php echo $heading ?>> -->
                        </div>
                      </div>
                    </div>
