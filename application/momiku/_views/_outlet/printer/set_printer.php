...
<script>
  jQuery(function($){
    $("#btnTesPrint").click(function(){
      ...
      $.ajax({
        url: '<?php echo base_url() ?>outlet/printer_retail/print_test',
        type: 'post',
        data: 'printer='+sport,
        success: function(){
            alert(sport);
  ...
  $(document).ready(function(){
    $('#printMethod').change(function(){
      var val = $(this).val();
      $.ajax({
        url  : "<?php echo base_url('outlet/printer_retail/change_print');?>",
        type : 'post',
        data : 'opsi='+val,
    ...
    $('#notesFormat').change(function(){
      var val = $(this).val();
      $.ajax({
        url  : "<?php echo base_url('outlet/printer_retail/change_format_nota');?>",
        type : 'post',
        data : 'format='+val,
        success:function(resposne){
