      ...
      <div id="sidebar" class="sidebar responsive ace-save-state sidebar-fixed">
        ...
        <ul class="nav nav-list">
          ...
          <li class="<?php if(isset($active_penjualan_create) || isset($active_order_sales) || isset($active_penjualan_sales) || isset($active_retur_penjualan_create) || isset($active_retur_penjualan_manual_create)){ echo 'active open';}; ?> highlight">
            ...
            <ul class="submenu">
              <li class="<?php if(isset($active_order_sales)){ echo $active_order_sales;}; ?> highlight">
                <a id="bOrderSales" href="<?php echo base_url() ?>outlet/order_sales">
                  <i class="menu-icon fa fa-shopping-cart"></i>
          ...
          <li class="<?php if(isset($active_packing)){ echo 'active open';}; ?> highlight">
            ...
            <b class="arrow"></b>
            <ul class="submenu">
              <li class="<?php if(isset($active_packing)){ echo $active_packing;}; ?> highlight">
                <!-- <a href="<?php echo base_url() ?>outlet/pembelian_retail/create"> -->
                <a href="<?php echo base_url() ?>outlet/packing">
                  <i class="menu-icon fa fa-gift"></i>
