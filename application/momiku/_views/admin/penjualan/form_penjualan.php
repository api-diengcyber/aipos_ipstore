                ...
                <div class="row">
                  <div class="col-xs-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="tgl" class="form-control" id="tampil_tgl_order" placeholder="Tgl Order" value="<?php echo $tgl_order; ?>" readonly />
                    </div>
                  </div>
...
var pil_harga = ["-- Pilih Harga --", "Harga 1", "Harga 2", "Harga 3", "Harga 4", "Harga 5", "Harga 6"];
...
$(document).ready(function(){
  ...
  $(".btn-selesai").on('click', function(){
    if (ibarang > 0) {
      ...
      $.ajax({
        url: '<?php echo base_url() ?>admin/penjualan_retail/create_action',
        type: 'post',
        processData: false,
        contentType: false,
        data: fd,
