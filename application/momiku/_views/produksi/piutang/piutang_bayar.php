                ...
                <form action="<?php echo $action; ?>" method="post">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control text-right" name="sisa" id="sisa" placeholder="Sisa Hutang" value="<?php echo number_format($sisa,0,',','.'); ?>" readonly />
                          </div>
                        </div>
                      </div>
                      <div class="form-group">
                  ...
                  <div class="row" style="margin-top:10px;">
                    <div class="col-md-12 text-center">
                      ...
                      <a href="<?php echo site_url('produksi/piutang_retail') ?>" class="btn btn-success">Lihat</a>
                      <button type="submit" class="btn btn-primary"><?php echo $button ?></button> 
                      <a href="<?php echo site_url('produksi/piutang_retail') ?>" class="btn btn-default">Cancel</a>
                    </div>
                  </div>
                </form>
...
jQuery(function($){
  var hitung = function(){
    ...
    var jumlah_bayar = $("#bayar").val().replace(/\./g,'');
