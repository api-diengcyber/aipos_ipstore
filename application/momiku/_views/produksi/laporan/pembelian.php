                      ...
                      <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>Rp <span style='float:right;'><?php echo number_format($key->harga_satuan,0,',','.') ?></span></td>
                            <td><?php echo $key->jumlah ?></td>
                            <td>Rp <span style='float:right;'><?php echo number_format($key->total_bayar,0,',','.') ?></span></td>
                          </tr>
                          <?php
                        ...
                        <tfoot>
                          <tr>
                            ...
                            <td>Rp <span style='float:right;'><?php echo number_format($total_harga,0,',','.') ?></span></td>
