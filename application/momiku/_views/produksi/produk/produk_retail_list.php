          ...
          <div class="page-content">
            ...
            <div class="row">
              <div class="col-xs-12">
                ...
                <div class="row" style="margin-bottom: 10px">
                    <div class="col-md-12">
                        <?php echo anchor(site_url('produksi/produk_retail/create'), 'Tambah Produk', 'class="btn btn-primary"'); ?>
                        <?php if ($id_modul == '5') { ?>
                        <button type="button" class="btn btn-success" id="btn_import_excel">Import Excel</button>
                        <div id="myModal" class="modal fade" role="dialog">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <form class="form-horizontal" action="<?php echo base_url() ?>produksi/produk_retail/import_excel/" method="post" enctype="multipart/form-data">
                        ...
                        <?php } ?>
                        <?php echo anchor(site_url('produksi/produk_retail/excel'), 'Export Excel', 'class="btn btn-inverse"'); ?>
                        <?php echo anchor(site_url('produksi/produk_retail/word'), 'Export Word', 'class="btn btn-inverse"'); ?>
                        <span class="pull-right">
                          <a href="<?php echo base_url() ?>produksi/produk_retail/edit_semua" class="btn btn-primary">Edit Semua</a>
                        </span>
                    </div>
                </div>
                ...
                <script type="text/javascript">
                    $(document).ready(function() {
                        ...
                        var t = $("#mytable").dataTable({
                            ...
                            processing: true,
                            serverSide: true,
                            ajax: {"url": "<?php echo base_url() ?>produksi/produk_retail/json", "type": "POST"},
                            columns: [
                                {
                                    "data": "id_produk_2",
                                    "orderable": false
                      ...
                      $('#mytable').on('draw.dt',function(){
                        $('select[name=mytable_length]').on('change',function(){
                            var val = $(this).val();
                            document.location = '<?php echo base_url("produksi/produk_retail?page='+val+'");?>';
                        });
                      })
                    });
                </script>
