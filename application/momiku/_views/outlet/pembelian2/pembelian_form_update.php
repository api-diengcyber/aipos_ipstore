          ...
          <div class="page-content">
            ...
            <div class="row">
              <div class="col-xs-12">
                ...
                <form action="<?php echo base_url() ?>outlet/pembelian/update_action" method="post">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="row">
      ...
      <script type="text/javascript">
        $(document).ready(function(){
          ...
          function addTemp(barcode) {
            ...
            $.ajax({
              url: '<?php echo base_url() ?>outlet/pembelian/tambah_temp_update',
              type: 'post',
          ...
          function listTemp() {
            ...
            $.ajax({
              url: '<?php echo base_url() ?>outlet/pembelian/list_temp_update',
              type: 'get',
              success: function(response){
          ...
          function jqueryTemp() {
            ...
            function updateTemp(id, data) {
              ...
              $.ajax({
                url: '<?php echo base_url() ?>outlet/pembelian/update_temp_update',
                type: 'post',
                data: 'id='+id+'&'+data,
                success: function(response){
            ...
            $(".btn-hapus-temp").on("click", function(e){
              ...
              $.ajax({
                url: '<?php echo base_url() ?>outlet/pembelian/hapus_temp_update',
                type: 'post',
                data: 'id='+id,
                success: function(response) {
                  listTemp();
