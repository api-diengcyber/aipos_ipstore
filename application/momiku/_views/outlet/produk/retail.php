...
<script>
  jQuery(function($){
    ...
    var addFuncDelete = function(){
      ...
      if(t > 0){
        $("[data-id]").click(function(){
          ...
          $.ajax({
            url: '<?php echo base_url() ?>outlet/retail/hapus_pengaturan',
            type: 'post',
            data: 'id='+id,
    ...
    var tampil = function(){
      ...
      var kode = $("#kode").val();
      $.ajax({
        url: '<?php echo base_url() ?>outlet/retail/lihat_pengaturan',
        type: 'post',
    ...
    $("#formPanel").submit(function(e){
      ...
      $.ajax({
        url: '<?php echo base_url() ?>outlet/retail/simpan_pengaturan',
        type: 'post',
        data: data,
        success: function(response){
          tampil();
