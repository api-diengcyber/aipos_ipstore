          ...
          <div class="page-content">
            ...
            <div class="row">
              <div class="col-xs-12">
                ...
                <form action="<?php echo base_url() ?>gudang/pembelian/create_action" method="post">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="row">
        ...
        $(document).ready(function(){
          $("#term").autocomplete({
            source: function(request, response){
              $.ajax({
                url: '<?php echo base_url() ?>gudang/pembelian/json_produk',
                type: 'post',
          ...
          function addTemp(barcode) {
            ...
            $.ajax({
              url: '<?php echo base_url() ?>gudang/pembelian/tambah_temp',
              type: 'post',
          ...
          function listTemp() {
            ...
            $.ajax({
              url: '<?php echo base_url() ?>gudang/pembelian/list_temp',
              type: 'get',
              success: function(response){
          ...
          function jqueryTemp() {
            ...
            function updateTemp(id, data) {
              ...
              $.ajax({
                url: '<?php echo base_url() ?>gudang/pembelian/update_temp',
                type: 'post',
                data: 'id='+id+'&'+data,
                success: function(response){
            ...
            $(".btn-hapus-temp").on("click", function(e){
              ...
              $.ajax({
                url: '<?php echo base_url() ?>gudang/pembelian/hapus_temp',
                type: 'post',
                data: 'id='+id,
                success: function(response) {
                  listTemp();
