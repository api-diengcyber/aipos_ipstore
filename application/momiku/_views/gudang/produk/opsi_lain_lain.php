              ...
              <div class="col-md-8" style="padding:20px">
                ...
                <div class="row">
                  <div class="col-xs-12" style="padding-left:20px">
                    ...
                    <form action="<?php echo base_url('gudang/retail/tanggal_change');?>" method="post">
      ...
      <script>
        $(document).ready(function(){
            $('#opsiPpn').click(function(){
                var val = $('#ppn').val();
                $.ajax({
                  url : '<?php echo base_url("gudang/retail/opsi_ppn_change");?>',
                  type: 'post',
                  data: 'opsi='+val,
            ...
            $('#opsiStock').change(function(){
              var val = $(this).val();
              $.ajax({
                url : '<?php echo base_url("gudang/retail/opsi_stok_change");?>',
                type: 'post',
                data: 'opsi='+val,
                success:function(response){
                  alert('Perubahan Berhasil.');
            ...
            $('#opsiDiskon').change(function(){
              var val = $(this).val();
              $.ajax({
                url : '<?php echo base_url("gudang/retail/opsi_diskon_change");?>',
                type: 'post',
                data: 'opsi='+val,
                success:function(response){
                  alert('Perubahan Berhasil.');
            ...
            $('#opsiPilihan').change(function(){
              var val = $(this).val();
              $.ajax({
                url : '<?php echo base_url("gudang/retail/opsi_pilihan_change");?>',
                type: 'post',
                data: 'opsi='+val,
                success:function(response){
                  alert('Perubahan Berhasil.');
            ...
            $('#opsiTProduk').change(function(){
              var val = $(this).val();
              $.ajax({
                url : '<?php echo base_url("gudang/retail/opsi_tproduk_change");?>',
                type: 'post',
                data: 'opsi='+val,
                success:function(response){
                  alert('Perubahan Berhasil.');
            ...
            $('#opsiPopup').change(function(){
              var val = $(this).val();
              $.ajax({
                url : '<?php echo base_url("gudang/retail/opsi_popup_change");?>',
                type: 'post',
                data: 'opsi='+val,
                success:function(response){
                  alert('Perubahan Berhasil.');
            ...
            $('#opsiUcapan').click(function(){
              var val = $('#ucapan').val();
              $.ajax({
                url : '<?php echo base_url("gudang/retail/ucapan_change");?>',
                type: 'post',
                data: 'ucapan='+val,
                success:function(response){
                  alert('Perubahan Berhasil.');
