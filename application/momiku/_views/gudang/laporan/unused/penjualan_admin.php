            ...
            <div class="row">
              <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                      ...
                      <table id="" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><a href="<?php echo base_url() ?>gudang/laporan_retail/detail_faktur/<?php echo $key->no_faktur ?>"><?php echo $key->no_faktur ?></a></td>
                            <?php if($id_modul!=1){ ?>
                    ...
                    <div class="row">
                      <form action="<?php echo base_url() ?>gudang/laporan_retail/cetak_rekap_penjualan" method="post" class="form-horizontal" target="_blank">
                        <div class="col-md-4">
                          <div class="form-group">
