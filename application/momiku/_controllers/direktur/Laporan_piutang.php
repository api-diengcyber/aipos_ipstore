...
class Laporan_piutang extends CI_Controller {
	...
	public function rekap_area()
	{
		...
		$data['data_kota'] = $this->db->select('*')
									  ...
									  ->get()->result();
		if ($print!="true") {
	        $this->view->render_direktur('laporan_baru/piutang_rekap_area', $data);
		} else {
			$this->load->view('direktur/laporan_baru/piutang_rekap_area', $data);
		}
	}
	...
	public function rinci_area()
	{
		...
		$data['data_kota'] = $this->db->select('*')
									  ...
									  ->get()->result();
		if ($print!="true") {
	        $this->view->render_direktur('laporan_baru/piutang_rinci_area', $data);
		} else {
			$this->load->view('direktur/laporan_baru/piutang_rinci_area', $data);
		}
	}
	...
	public function rekap()
	{
		...
		$data['data_kota'] = $this->db->select('*')
									  ...
									  ->get()->result();
		if ($print!="true") {
	        $this->view->render_direktur('laporan_baru/piutang_rekap', $data);
		} else {
			$this->load->view('direktur/laporan_baru/piutang_rekap', $data);
		}
	}
