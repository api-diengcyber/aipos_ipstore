...
class Laporan_hutang extends CI_Controller {
	...
	public function rekap()
	{
		...
		if ($print!="true") {
	        $this->view->render_direktur('laporan_baru/hutang2', $data);
		} else {
			$this->load->view('direktur/laporan_baru/hutang2', $data);
		}
	}
	...
	public function rinci()
	{
		...
		$data['akhir_periode'] = $akhir_periode;
		if ($print!="true") {
	        $this->view->render_direktur('laporan_baru/hutang_rinci', $data);
		} else {
			$this->load->view('direktur/laporan_baru/hutang_rinci', $data);
		}
	}
