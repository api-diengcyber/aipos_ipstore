...
class Laporan_retail extends CI_Controller {
	...
	public function stok_produk()
	{
        $data = array(
            ...
            'contents' => $this->db->select('pr.*, sat.satuan AS satuan_produk, SUM(sp.stok) AS stok')
									...
									->group_by('sp.id_produk')
									->get()->result()
        );
        $this->view->render_direktur('laporan/stok_produk', $data);
	}
	...
	public function cetak_stok_produk()
	{
		...
		$data['contents'] = $this->db->select('pr.*, sp.satuan AS satuan_produk, SUM(stok.stok) AS stok')
									...
									->get()->result();
		$this->load->view('direktur/laporan/cetak_stok_produk', $data, FALSE);
	}
	...
	public function stok_mati()
	{
        ...
        $this->view->render_direktur('laporan/stok_mati', $data);
	}
	...
	public function penjualan()
	{
		...
		// if($this->userdata->level=="1"){
	        ...
	        $this->view->render_direktur('laporan/penjualan_admin', $data);
		// } else{
	 ...
	 //        $this->view->render_direktur('laporan/penjualan_kasir', $data);
		// }
	}
    ...
    public function penjualan_karyawan() {
        ...
        $this->view->render_direktur('laporan/penjualan_karyawan', $data);
    }
		...
		if($row){
			...
			$data = array(
				...
				'detail_order' => $this->db->select('od.*, pr.nama_produk, pr.mingros, pr.harga_1, pr.harga_2, pr.harga_3, pr.diskon AS diskon_produk, o.diskon_member, rjd.jumlah AS jumlah_retur, rjd.subtotal AS total_retur')
										...
										->group_by('pr.id_produk_2')
										->get()->result(),
				'cetak' => site_url('direktur/penjualan_retail/cetak_nota_penjualan/'.$no_faktur.''),
			);
	        $this->view->render_direktur('laporan/detail_faktur_v2', $data);
		} else {
			redirect('direktur/laporan_retail/penjualan','refresh');
		}
	}
	...
	public function cetak_rekap_penjualan()
	{
		...
		if ($submit=="excel") {
			redirect("direktur/produk_retail/excel_rekap_bulan/".$bulan."/".$tahun);
		} else {
			...
			$this->load->view('direktur/laporan/cetak_rekap', $data);
		}
	}
	...
	public function kasir()
	{
        ...
        $this->view->render_direktur('laporan/kasir', $data);
	}
	...
	public function pembelian()
	{
		...
		$data['awal_periode'] = $awal_periode;
		$data['akhir_periode'] = $akhir_periode;
        $this->view->render_direktur('laporan/pembelian', $data);
	}
	...
	public function buku_besar_1()
	{
        ...
        $this->view->render_direktur('laporan/buku_besar_1', $data);
	}
	...
	public function cetak_buku_besar_1()
	{
		if($this->userdata){
			...
			$this->load->view('direktur/laporan/cetak_buku_besar_1', $data);
		} else {
			$this->load->view('/');
		}
	}
	...
	public function buku_besar_2()
	{
        ...
        $this->view->render_direktur('laporan/buku_besar_2', $data);
	}
	...
	public function cetak_buku_besar_2()
	{
		if($this->userdata){
			...
			$this->load->view('direktur/laporan/cetak_buku_besar_2', $data);
		} else {
			$this->load->view('/');
		}
	}
	...
	public function neraca()
	{
        ...
        $this->view->render_direktur('laporan/neraca', $data);
	}
	...
	public function labarugi()
	{
        ...
        $this->view->render_direktur('laporan/laba_rugi', $data);
	}
	...
	public function piutang()
	{
		...
		$data['awal_periode'] = $awal_periode;
		$data['akhir_periode'] = $akhir_periode;
        $this->view->render_direktur('laporan/piutang', $data);
	}
	...
	public function hutang()
	{
        ...
        $this->view->render_direktur('laporan/hutang', $data);
	}
	...
	public function salesman()
	{
        ...
        $this->view->render_direktur('laporan/sales', $data);
	}
	...
	public function detail_sales($id_user, $tgl)
	{
        ...
        $this->view->render_direktur('laporan/detail_sales', $data);
	}
	...
	public function produk()
	{
		...
		if ($print=="true") {
			$this->load->view('direktur/laporan/ts_produk', $data, FALSE);
		} else {
	        $this->view->render_direktur('laporan/ts_produk', $data);
		}
	}
	...
	public function cetak_ts_produk()
	{
		...
		$this->load->view('direktur/laporan/ts_produk_cetak', $data, FALSE);
	}
