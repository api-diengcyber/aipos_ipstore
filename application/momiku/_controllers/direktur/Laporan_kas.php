...
class Laporan_kas extends CI_Controller {
	...
	public function harian()
	{
		...
		$res_pil_transaksi = $this->db->select('pt.*')
									  ...
									  ->join('pil_transaksi pt', 'j.id_transaksi=pt.id_pil_transaksi AND pt.id_users=u.id_users AND j.id_toko=pt.id_toko')
		...
		if ($print!="true") {
	        $this->view->render_direktur('laporan_baru/kas_harian', $data);
		} else {
			$this->load->view('direktur/laporan_baru/kas_harian', $data);
		}
	}
	...
	public function bulanan()
	{
		...
		if ($print!="true") {
	        $this->view->render_direktur('laporan_baru/kas_bulanan', $data);
		} else {
			$this->load->view('direktur/laporan_baru/kas_bulanan', $data);
		}
	}
