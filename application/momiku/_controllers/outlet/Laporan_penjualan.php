...
class Laporan_penjualan extends CI_Controller {
	...
	public function rinci_per_area()
	{
		...
		$data['data_sales_from_orders'] = $this->db->select('o.*, u2.email, u2.first_name, u2.last_name')
													...
													->get()->result();
		if ($print!="true") {
	        $this->view->render_outlet('laporan_baru/penjualan_rinci_per_area', $data);
		} else {
			$this->load->view('outlet/laporan_baru/penjualan_rinci_per_area', $data);
		}
	}
	...
	public function rekap_per_area()
	{
		...
		$data['data_sales_from_orders'] = $this->db->select('o.*, u2.email, u2.first_name, u2.last_name')
													...
													->get()->result();
		if ($print=="true") {
			$this->load->view('outlet/laporan_baru/penjualan_rekap_per_area', $data, FALSE);
		} else {
	        $this->view->render_outlet('laporan_baru/penjualan_rekap_per_area', $data);
		}
	}
	...
	public function rekap()
	{
		...
		$data['data_kota_from_orders'] = $this->db->select('k.*')
													...
													->get()->result();
		if ($print=="true") {
			$this->load->view('outlet/laporan_baru/penjualan_rekap_area', $data, FALSE);
		} else {
	        $this->view->render_outlet('laporan_baru/penjualan_rekap_area', $data);
		}
	}
