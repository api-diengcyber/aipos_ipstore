...
class Retail extends CI_Controller {
	...
	public function stok_produk()
	{
        $data = array(
            ...
            'action' => site_url('outlet/retail/action_simpan_stok_produk'),
            'id_modul' => $this->userdata->id_modul,
        );
        $this->view->render_outlet('produk/stok_produk', $data);
	}
	...
	public function lain_lain() {
		...
		$data['ucapan'] = $ucapan;
        $this->view->render_outlet('produk/opsi_lain_lain', $data);
	}
	...
	public function tanggal_change()
	{
        ...
        redirect(site_url('outlet/retail/lain_lain'),'refresh');
	}
	...
	public function diskon_produk()
	{
        $data = array(
            ...
            'action' => site_url('outlet/retail/action_simpan_diskon_produk'),
        );
        $this->view->render_outlet('produk/diskon_produk', $data);
	}
	...
	public function action_simpan_diskon_produk()
	{
		...
		redirect('outlet/retail/diskon_produk', 'refresh');
	}
	public function json_expire($date_expire = '')
	{
        header('Content-Type: application/json');
		echo $this->Pembelian_retail_model->json_by_expire($this->userdata->id_toko, $date_expire);
	}
	...
	public function produk_kadaluarsa()
	{
        ...
        $this->view->render_outlet('produk/produk_kadaluarsa', $data);
	}
	...
	public function grafik()
	{
        ...
        $this->view->render_outlet('produk/grafik', $data);
	}
	...
	public function pengaturan()
	{
        ...
        $this->view->render_outlet('produk/retail', $data);
	}
	...
	{
		$this->load->view('outlet/htmljson');
	}

	public function data_json()
	{
        header('Content-Type: application/json');
        $html = file_get_contents(site_url('outlet/retail/coba_html'));
        $data_div = array();
