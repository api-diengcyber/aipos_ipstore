...
class Hutang_retail extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->view->render_outlet('hutang/hutang_list', $data);
    } 
    ...
    public function read($id) 
    {
        ...
        if ($row) {
            ...
            $this->view->render_outlet('hutang/hutang_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('outlet/hutang_retail'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            ...
            'nama_modul' => $this->userdata->nama_modul,
            'button' => 'Tambah',
            'action' => site_url('outlet/hutang_retail/create_action'),
            'id' => set_value('id'),
            'tgl' => date("d-m-Y"),
            'id_toko' => $this->userdata->id_toko,
        ...
        $this->view->render_outlet('hutang/hutang_form', $data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                ...
                'nama_modul' => $this->userdata->nama_modul,
                'button' => 'Simpan',
                'action' => site_url('outlet/hutang_retail/update_action'),
