...
class Member_retail extends CI_Controller
{
    ...
    public function json() {
        ...
        if ($this->userdata->level=='1') {
            ...
            echo $this->Member_retail_model->json_kasir($this->userdata->id_toko);
        } else if ($this->userdata->level=='3') {
            echo $this->Member_retail_model->json_kasir($this->userdata->id_toko);
        } else if ($this->userdata->level=='4') {
            echo $this->Member_retail_model->json_sales($this->userdata->id_toko);
        }
    }
    ...
    public function index()
    {
        ...
        $this->view->render_outlet('member/member_list', $data);
    }
    ...
    public function order_sales($id_member)
    {
        ...
        $this->view->render_outlet('member/order_sales', $data);
    }
    ...
    public function order_sales_action($id_member)
    {
        ...
        redirect('outlet/member_retail/order_sales_acc/'.$id_member);
    }
    ...
    public function order_sales_acc($id_member)
    {
        ...
        $this->view->render_outlet('member/order_sales_acc', $data);
    }
    ...
    public function read($id) 
    {
        ...
        if ($row) {
            ...
            $this->view->render_outlet('member/member_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('outlet/member'));
        }
    }
    ...
    public function proses_orders()
    {
        ...
        redirect('outlet/penjualan_retail/create?id_member='.$id_member);
    }
    ...
    public function create() 
    {
        ...
        $data = array(
            ...
            'nama_modul' => $this->userdata->nama_modul,
            'button' => 'Tambah',
            'action' => site_url('outlet/member_retail/create_action'),
            'id' => set_value('id'),
            'id_toko' => $this->userdata->id_toko,
        ...
        $this->view->render_outlet('member/member_form', $data);
    }
    ...
    public function create_action()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect(site_url('outlet/member_retail'));
        }
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                ...
                'nama_modul' => $this->userdata->nama_modul,
                'button' => 'Simpan',
                'action' => site_url('outlet/member_retail/update_action'),
    ...
    public function word()
    {
        ...
        $this->load->view('outlet/member/member_doc',$data);
    }
    ...
    public function kartu_pelanggan()
    {
        ...
        $this->view->render_outlet('member/member_card', $data);
    }
    ...
    public function kartu_pelanggan_action()
    {
        ...
        $this->load->view('outlet/member/cetak_member_card', $data, FALSE);
    }
    ...
    public function semua_order()
    {
        ...
        $this->view->render_outlet('member/semua_order', $data);
    }
    ...
    public function semua_order_detail($id)
    {
        $row_sales_temp = $this->db->select('ost.id, ost.id_orders_temp, ost.tgl, ost.id_member, SUM(ost.jumlah) AS jml_qty, m.nama, m.alamat')
                                    ...
                                    ->get()->row();
        if (!$row_sales_temp) {
            redirect('outlet/member_retail/semua_order', 'refresh');
        }
        $jenis = 0;
        ...
        $this->view->render_outlet('member/semua_order_detail', $data);
    }
