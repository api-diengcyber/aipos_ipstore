...
class Laporan_retail extends CI_Controller {
	...
	public function stok_produk()
	{
        ...
        $this->view->render_outlet('laporan/stok_produk', $data);
	}
	...
	public function cetak_stok_produk()
	{
		...
		$data['contents'] = $this->db->select('produk_retail.*, satuan_produk.satuan AS satuan_produk, SUM(stok_produk.stok) AS stok')
									...
									->group_by('stok_produk.id_produk')
									->get()->result();
		$this->load->view('outlet/laporan/cetak_stok_produk', $data, FALSE);
	}
	...
	public function stok_mati()
	{
        ...
        $this->view->render_outlet('laporan/stok_mati', $data);
	}
	...
	public function penjualan()
	{
		...
		// if($this->userdata->level=="1"){
	        ...
	        $this->view->render_outlet('laporan/penjualan_admin', $data);
		// } else{
	 ...
	 //        $this->view->render_outlet('laporan/penjualan_kasir', $data);
		// }
	}
    ...
    public function penjualan_karyawan() {
        ...
        $this->view->render_outlet('laporan/penjualan_karyawan', $data);
    }
	...
	public function detail_faktur($no_faktur)
	{
		...
		if($row){
	        ...
	        $this->view->render_outlet('laporan/detail_faktur_v2', $data);
		} else {
			redirect('outlet/laporan_retail/penjualan','refresh');
		}
	}
	...
	public function cetak_rekap_penjualan()
	{
		...
		if ($submit=="excel") {
			redirect("outlet/produk_retail/excel_rekap_bulan/".$bulan."/".$tahun);
		} else {
			...
			$this->load->view('outlet/laporan/cetak_rekap', $data);
		}
	}
	...
	public function kasir()
	{
        ...
        $this->view->render_outlet('laporan/kasir', $data);
	}
	...
	public function pembelian()
	{
		...
		$data['awal_periode'] = $awal_periode;
		$data['akhir_periode'] = $akhir_periode;
        $this->view->render_outlet('laporan/pembelian', $data);
	}
	...
	public function buku_besar_1()
	{
        ...
        $this->view->render_outlet('laporan/buku_besar_1', $data);
	}
	...
	public function cetak_buku_besar_1()
	{
		if($this->userdata){
			...
			$this->load->view('outlet/laporan/cetak_buku_besar_1', $data);
		} else {
			$this->load->view('/');
		}
	}
	...
	public function buku_besar_2()
	{
        ...
        $this->view->render_outlet('laporan/buku_besar_2', $data);
	}
	...
	public function cetak_buku_besar_2()
	{
		if($this->userdata){
			...
			$this->load->view('outlet/laporan/cetak_buku_besar_2', $data);
		} else {
			$this->load->view('/');
		}
	}
	...
	public function neraca()
	{
        ...
        $this->view->render_outlet('laporan/neraca', $data);
	}
	...
	public function labarugi()
	{
        ...
        $this->view->render_outlet('laporan/laba_rugi', $data);
	}
	...
	public function piutang()
	{
		...
		$data['awal_periode'] = $awal_periode;
		$data['akhir_periode'] = $akhir_periode;
        $this->view->render_outlet('laporan/piutang', $data);
	}
	...
	public function hutang()
	{
        ...
        $this->view->render_outlet('laporan/hutang', $data);
	}
	...
	public function salesman()
	{
        ...
        $this->view->render_outlet('laporan/sales', $data);
	}
	...
	public function detail_sales($id_user, $tgl)
	{
        ...
        $this->view->render_outlet('laporan/detail_sales', $data);
	}
	...
	public function produk()
	{
		...
		if ($print=="true") {
			$this->load->view('outlet/laporan/ts_produk', $data, FALSE);
		} else {
	        $this->view->render_outlet('laporan/ts_produk', $data);
		}
	}
	...
	public function cetak_ts_produk()
	{
		...
		$this->load->view('outlet/laporan/ts_produk_cetak', $data, FALSE);
	}
