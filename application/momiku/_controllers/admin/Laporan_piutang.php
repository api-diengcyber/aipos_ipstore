...
class Laporan_piutang extends CI_Controller {
	...
	public function rekap_area()
	{
		...
		$data['data_kota'] = $this->db->select('*')
									  ...
									  ->get()->result();
		if ($print!="true") {
	        $this->view->render_admin('laporan_baru/piutang_rekap_area', $data);
		} else {
	...
	public function rinci_area()
	{
		...
		$data['data_kota'] = $this->db->select('*')
									  ...
									  ->get()->result();
		if ($print!="true") {
	        $this->view->render_admin('laporan_baru/piutang_rinci_area', $data);
		} else {
	...
	public function rekap()
	{
		...
		$data['data_kota'] = $this->db->select('*')
									  ...
									  ->get()->result();
		if ($print!="true") {
	        $this->view->render_admin('laporan_baru/piutang_rekap', $data);
		} else {
