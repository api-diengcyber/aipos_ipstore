...
class Retur_jual extends CI_Controller {
	...
	public function index()
	{
        ...
        $this->view->render_admin('retur_jual/retur_jual_list', $data);
	}
	...
	public function read($id)
	{
		...
		if ($row_retur) {
            ...
            $this->view->render_admin('retur_jual/retur_jual_read', $data);
		} else {
	...
	public function json()
	{
		...
		echo $this->Retur_jual_model->json($this->userdata->id_toko,1);
	}
...
/*
    ...
    public function create()
    {
        ...
        $this->view->render_admin('retur_jual/retur_jual_form', $data);
    }
    ...
    public function create_manual($value='')
    {
        ...
        $this->view->render_admin('retur_jual/retur_jual_form_manual', $data);
    }
