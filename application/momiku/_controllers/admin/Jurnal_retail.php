...
class Jurnal_retail extends CI_Controller {
	...
	public function umum_create()
	{
        ...
        if($row){
            ...
            $this->view->render_admin('jurnal/umum/umum_form', $data);
        }
	}
	...
	public function penerimaan_kas_create()
	{
        ...
        if($row){
            ...
            $this->view->render_admin('jurnal/penerimaan_kas/penerimaan_kas_form', $data);
        }
	}
	...
	public function pengeluaran_kas_create()
	{
        ...
        if($row){
            ...
            $this->view->render_admin('jurnal/pengeluaran_kas/pengeluaran_kas_form', $data);
        }
	}
	...
	public function bayar_piutang_create($id_piutang = NULL)
	{
        ...
        if($row){
            ...
            $this->view->render_admin('jurnal/piutang/piutang_form', $data);
        }
	}
	...
	public function bayar_hutang_create($id_hutang = NULL)
	{
        ...
        if($row){
            ...
            $this->view->render_admin('jurnal/hutang/hutang_form', $data);
        }
	}
	...
	public function pengaturan()
	{
        ...
        $this->view->render_admin('jurnal/pengaturan', $data);
	}
    ...
    public function buat_jurnal()
    {
        ...
        $this->view->render_admin('jurnal/buat_jurnal', $data);
    }
