...
class Supplier_retail extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->view->render_admin('supplier/supplier_list', $data);
    }
    ...
    public function read($id) 
    {
        ...
        if ($row) {
            ...
            $this->view->render_admin('supplier/supplier_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->view->render_admin('supplier/supplier_form', $data);
