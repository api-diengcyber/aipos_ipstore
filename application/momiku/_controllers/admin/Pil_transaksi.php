...
class Pil_transaksi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->view->render_admin('pil_transaksi/pil_transaksi_list', $data);
    } 
    ...
    public function read($id) 
    {
        ...
        if ($row) {
            ...
            $this->view->render_admin('pil_transaksi/pil_transaksi_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->view->render_admin('pil_transaksi/pil_transaksi_form', $data);
    }
