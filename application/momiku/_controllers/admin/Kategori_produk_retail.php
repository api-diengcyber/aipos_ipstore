...
class Kategori_produk_retail extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->view->render_admin('kategori_produk/kategori_produk_list', $data);
    } 
    ...
    public function read($id) 
    {
        ...
        if ($row) {
            ...
            $this->view->render_admin('kategori_produk/kategori_produk_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->view->render_admin('kategori_produk/kategori_produk_form', $data);
    }
