...
class Laporan_retail extends CI_Controller {
	...
	public function stok_produk()
	{
        ...
        $this->view->render_admin('laporan/stok_produk', $data);
	}
	...
	public function cetak_stok_produk()
	{
		...
		$data['contents'] = $this->db->select('pr.*, sp.satuan AS satuan_produk, (SELECT SUM(stok) as stok FROM stok_produk sp WHERE pr.id_produk_2=sp.id_produk AND sp.id_toko=pr.id_toko) as stok')
									->from('produk_retail pr')
									->join('users u', 'pr.id_users=u.id_users AND pr.id_toko=u.id_toko')
									->join('pembelian p', 'pr.id_produk_2=p.id_produk AND p.id_users=u.id_users AND pr.id_toko=p.id_toko', 'left')
	...
	public function stok_mati()
	{
        ...
        $this->view->render_admin('laporan/stok_mati', $data);
	}
	...
	public function penjualan()
	{
		...
		// if($this->userdata->level=="1"){
	        ...
	        $this->view->render_admin('laporan/penjualan_admin', $data);
		// } else{
	 ...
	 //        $this->view->render_admin('laporan/penjualan_kasir', $data);
		// }
	}
    ...
    public function penjualan_karyawan() {
        ...
        $this->view->render_admin('laporan/penjualan_karyawan', $data);
    }
	...
	public function detail_faktur($no_faktur)
	{
		...
		if($row){
	        ...
	        $this->view->render_admin('laporan/detail_faktur_v2', $data);
		} else {
	...
	public function cetak_rekap_penjualan()
	{
		...
		if ($submit=="excel") {
			redirect("admin/produk_retail/excel_rekap_bulan/".$bulan."/".$tahun);
		} else {
	...
	public function kasir()
	{
        ...
        $this->view->render_admin('laporan/kasir', $data);
	}
	...
	public function pembelian()
	{
		...
		$data['awal_periode'] = $awal_periode;
		$data['akhir_periode'] = $akhir_periode;
        $this->view->render_admin('laporan/pembelian', $data);
	}
	...
	public function buku_besar_1()
	{
        ...
        $this->view->render_admin('laporan/buku_besar_1', $data);
	}
	...
	public function buku_besar_2()
	{
        ...
        $this->view->render_admin('laporan/buku_besar_2', $data);
	}
	...
	public function neraca()
	{
        ...
        $this->view->render_admin('laporan/neraca', $data);
	}
	...
	public function labarugi()
	{
        ...
        $this->view->render_admin('laporan/laba_rugi', $data);
	}
	...
	public function piutang()
	{
		...
		$data['awal_periode'] = $awal_periode;
		$data['akhir_periode'] = $akhir_periode;
        $this->view->render_admin('laporan/piutang', $data);
	}
	...
	public function hutang()
	{
        ...
        $this->view->render_admin('laporan/hutang', $data);
	}
	...
	public function salesman()
	{
        ...
        $this->view->render_admin('laporan/sales', $data);
	}
	...
	public function detail_sales($id_user, $tgl)
	{
        ...
        $this->view->render_admin('laporan/detail_sales', $data);
	}
	...
	public function produk()
	{
		...
		if ($print=="true") {
	        ...
	        $this->view->render_admin('laporan/ts_produk', $data);
		}
	}
