...
class Produk_retail extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->view->render_admin('produk/produk_retail_list', $data);
    }
    ...
    public function read($id) 
    {
        ...
        if ($row) {
	        ...
	        $this->view->render_admin('produk/produk_retail_read', $data);
        } else {
    ...
    public function create($bar = NULL)
    {
        ...
        $this->view->render_admin('produk/produk_retail_form', $data);
    }
    ...
    public function edit_semua()
    {
        ...
        $this->view->render_admin('produk/edit_semua', $data);
    }
