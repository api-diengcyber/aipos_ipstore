...
class Member_retail extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->view->render_admin('member/member_list', $data);
    }
    ...
    public function order_sales($id_member)
    {
        ...
        $this->view->render_admin('member/order_sales', $data);
    }
    ...
    public function order_sales_acc($id_member)
    {
        ...
        $this->view->render_admin('member/order_sales_acc', $data);
    }
    ...
    public function read($id) 
    {
        ...
        if ($row) {
            ...
            $this->view->render_admin('member/member_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->view->render_admin('member/member_form', $data);
    }
    ...
    public function kartu_pelanggan()
    {
        ...
        $this->view->render_admin('member/member_card', $data);
    }
    ...
    public function semua_order()
    {
        ...
        $this->view->render_admin('member/semua_order', $data);
    }
    ...
    public function semua_order_detail($id)
    {
        ...
        $this->view->render_admin('member/semua_order_detail', $data);
    }
