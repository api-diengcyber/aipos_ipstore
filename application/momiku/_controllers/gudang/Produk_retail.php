...
class Produk_retail extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->view->render_gudang('produk/produk_retail_list', $data);
    }
    ...
    public function read($id) 
    {
        ...
        if ($row) {
	        ...
	        $this->view->render_gudang('produk/produk_retail_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('gudang/retail'));
        }
    }
    ...
    public function create($bar = NULL)
    {
        ...
        $data = array(
            ...
            'nama_modul' => $this->userdata->nama_modul,
            'button' => 'Tambah',
            'action' => site_url('gudang/produk_retail/create_action'),
        ...
        $this->view->render_gudang('produk/produk_retail_form', $data);
    }
    ...
    public function create_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect(site_url('gudang/produk_retail'));
        }
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
	        ...
	        $data = array(
	            ...
	            'nama_modul' => $this->userdata->nama_modul,
                'button' => 'Simpan',
                'action' => site_url('gudang/produk_retail/update_action'),
    ...
    public function word()
    {
        ...
        $this->load->view('gudang/produk/produk_retail_doc',$data);
    }
    ...
    public function cetak_label_barcode()
    {
		...
		$this->load->view('gudang/produk/cetak_label_barcode', $data);
    }
    ...
    public function edit_semua()
    {
        ...
        $this->view->render_gudang('produk/edit_semua', $data);
    }
