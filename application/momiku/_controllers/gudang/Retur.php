...
class Retur extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->view->render_gudang('retur/retur_list', $data);
    }
    ...
    public function read($id)
    {
        ...
        if ($data_retur) {
            ...
            $this->view->render_gudang('retur/retur_read', $data);
        } else {
	...
	public function create()
	{
        $data = array(
            ...
            'id_modul' => $this->userdata->id_modul,
            'nama_modul' => $this->userdata->nama_modul,
            'action' => site_url('gudang/retur/create_action'),
            'id' => set_value('id'),
        ...
        $this->view->render_gudang('retur/retur_form', $data);
	}
	...
	public function update($id)
	{
        ...
        if ($row) {
            $data = array(
                ...
                'id_modul' => $this->userdata->id_modul,
                'nama_modul' => $this->userdata->nama_modul,
                'action' => site_url('gudang/retur/update_action'),
