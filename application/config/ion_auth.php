 ...
 */
$config['site_title']                 = "aipos.id";       // Site Title, example.com
$config['admin_email']                = "support@aipos.id"; // Admin Email, admin@example.com
...
$config['email_activate'] = 'email_activate.php';
