...
class Pegawai_retail_model extends CI_Model
{
    ...
    function json_sales() {
        ...
        $this->datatables->add_column('pelanggan','-');
        $this->datatables->add_column('gaji','1800000');
        // $this->datatables->add_column('b','340000');
        ...
        $this->datatables->add_column('action', anchor(site_url('manager/pegawai_retail/update/$1'),'<button class="btn btn-xs btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></button>')."&nbsp;&nbsp;&nbsp;&nbsp;".anchor(site_url('manager/pegawai_retail/delete/$1'),'<button class="btn btn-xs btn-danger"><i class="ace-icon fa fa-trash-o bigger-120"></i></button>','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id_users');
        } else if($this->userdata->level == 1) { //admin
            $this->datatables->add_column('action', anchor(site_url('admin/pegawai_retail/update/$1'),'<button class="btn btn-xs btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></button>')."&nbsp;&nbsp;&nbsp;&nbsp;".anchor(site_url('admin/pegawai_retail/delete/$1'),'<button class="btn btn-xs btn-danger"><i class="ace-icon fa fa-trash-o bigger-120"></i></button>','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id_users');
        }
        $this->db->order_by('active', 'desc');
        $this->db->order_by('level', 'asc');
        $this->db->order_by('first_name', 'asc');
    ...
    // datatables
    function json_advertiser() {
        $this->datatables->select('id,id_users,id_toko,ip_address,username,password,salt,email,activation_code,forgotten_password_code,forgotten_password_time,remember_code,created_on,last_login,active,first_name,last_name,company,phone,level, IF(level="1", "Admin", "Kasir") AS levels');
        $this->datatables->from('users');
        $this->datatables->where('level', '10');
        $this->datatables->where('id_toko', $this->userdata->id_toko);
        $this->datatables->where('id_cabang', $this->userdata->id_cabang);
        if($this->userdata->level == 3) {
        $this->datatables->add_column('action', anchor(site_url('outlet/advertiser/update/$1'),'<button class="btn btn-xs btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></button>')."&nbsp;&nbsp;&nbsp;&nbsp;".anchor(site_url('outlet/advertiser/delete/$1'),'<button class="btn btn-xs btn-danger"><i class="ace-icon fa fa-trash-o bigger-120"></i></button>','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id_users');
        } else if($this->userdata->level == 5) {
        $this->datatables->add_column('action', anchor(site_url('manager/advertiser/update/$1'),'<button class="btn btn-xs btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></button>')."&nbsp;&nbsp;&nbsp;&nbsp;".anchor(site_url('manager/advertiser/delete/$1'),'<button class="btn btn-xs btn-danger"><i class="ace-icon fa fa-trash-o bigger-120"></i></button>','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id_users');
        } else if($this->userdata->level == 1) { //admin
            $this->datatables->add_column('action', anchor(site_url('admin/advertiser/update/$1'),'<button class="btn btn-xs btn-info"><i class="ace-icon fa fa-pencil bigger-120"></i></button>')."&nbsp;&nbsp;&nbsp;&nbsp;".anchor(site_url('admin/advertiser/delete/$1'),'<button class="btn btn-xs btn-danger"><i class="ace-icon fa fa-trash-o bigger-120"></i></button>','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id_users');
        }
        $this->db->order_by('active', 'desc');
        $this->db->order_by('level', 'asc');
        $this->db->order_by('first_name', 'asc');
