<div class="main-content">
    <div class="main-content-inner">
        ...
        <div class="page-content">
            <div class="row">
                <div class="col-xs-12">
                    <h2 style="margin-top:0px">Group Produk CS <?php echo $button ?></h2>
                    <form action="<?php echo $action; ?>" method="post">
                        ...
                        <div class="form-group">
                            <label for="double">Produk <?php echo form_error('id_produk') ?></label>
                        ...
                        <a href="<?php echo site_url('admin/group_produk_cs') ?>" class="btn btn-default">Cancel</a>
                    </form>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.page-content -->
