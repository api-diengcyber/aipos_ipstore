          ...
          <div class="page-content">
            ...
            <div class="row">
              <div class="col-xs-12">
                ...
                <div class="row" style="margin-bottom: 10px">
                  ...
                  <div class="col-md-3">
                    <select multiple="" class="chosen-select form-control" data-placeholder="Pilih Kolom">
                      ...
                      <option value="4">Stok Sekarang</option>
                ...
                <a href="<?php echo base_url() ?>penyesuaian_stok" class="btn btn-default"><< Kembali</a>
...
<?php 
  ...
  function loadData(data) {
    $.ajax({
      url: '<?php echo base_url() ?>admin/produk_retail/json_data/<?php echo $tgl ?>',
      type: 'get',
  ...
  function saveData(data, result) {
    $.ajax({
      ...
      type: 'post',
      data: 'data='+JSON.stringify(data)+'&tgl=<?php echo $tgl ?>',
      success: function(response){
        result(response);
      }
    });
