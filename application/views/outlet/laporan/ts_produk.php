        ...
        <div class="main-content-inner">
          <div class="breadcrumbs ace-save-state breadcrumbs-fixed" id="breadcrumbs">
            <ul class="breadcrumb">
              ...
              <li class="active">Timeseries Produk</li>
            </ul><!-- /.breadcrumb -->
          ...
          <div class="page-content">
            ...
            <div class="row">
              <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                <div class="row">
                  <div class="col-md-4" style="margin-bottom:10px;"><a href="<?php echo base_url() ?>laporan_retail/produk?print=true" target="_blank" class="btn btn-primary">Print</a></div>
                  ...
                  <?php } ?>
                    <div class="table-responsive">
                      ...
                      <div class="text-center">
                         <h1 style="margin-top:15px;margin-bottom:15px;">Timeseries Produk</h1>
                      </div>
                      <?php } ?>
