              ...
              <div class="col-xs-12">
                ...
                <div class="alert alert-info">
                  ...
                  <div class="row" style="margin-bottom: 10px">
                      ...
                      <div class="col-md-2">
                        <h6>Retur</h6>
                        <select name="jenis_retur" class="form-control">
                          <option value="0">-- Semua --</option>
                          <option value="5" <?php echo $jenis_retur=="5"?"selected":"" ?>>Retur COD</option>
                          <option value="6" <?php echo $jenis_retur=="6"?"selected":"" ?>>Retur Garansi</option>
                        </select>
                      </div>
                      <div class="col-md-2">
                        <h6>&nbsp;</h6>
                    ...
                    <tbody>
                      ...
                      <tr style="<?php echo $tr_style ?>">
                        ...
                        <td>
                            ...
                            <?php if ($order_sales->pembayaran == 5 || $order_sales->pembayaran == 6) { ?>
                            <a onclick="return confirm('Are you sure ? ')" href="<?php echo base_url() ?>admin/laporan_retur/batal_retur/<?php echo $order_sales->id_order ?>" class="btn btn-danger btn-xs">Batalkan retur</a>
                            <?php } ?>
                        </td>
                        <td>
                        ...
                        <td>
                          <ul class="list-unstyled">
                            ...
                            <?php } ?>
                            <?php 
                            if ($order_sales->pembayaran == "5") {
                              echo "<li style='color:blue;'>Retur COD</li>";
                            } else if ($order_sales->pembayaran == "6") {
                              echo "<li style='color:green;'>Retur Garansi</li>";
                            }
                            ?>
                          </ul>
                        </td>
