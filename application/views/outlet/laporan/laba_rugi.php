                ...
                <div class="row">
                  <div class="col-xs-6">
                    ...
                    foreach ($data_saldo->result() as $key_saldo) {
                      if($key_saldo->id_akun == '44'){
                        $saldo_hpp = $key_saldo->saldo * -1;
                      }
                    }
                      $saldo_pendapatan = 0;
                      ...
                      <?php endforeach;
                      $saldo_pendapatan += $saldo_hpp;
                      ?>
                        <tr>
                          <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4.03 <b>HPP</b></td>
                          <td>Rp <span style="float:right;">(<?php echo number_format($saldo_hpp*-1,0,',','.') ?>)</span></td>
                        </tr>
                      <tr>
                      ...
                      <!-- <tr>
                        <th>Lain-lain </th>
                        <th>Rp <span style="float:right;"><?php // echo number_format($saldo_labarugi,0,',','.') ?></span></th>
                      </tr>
                      <tr>
                        <td colspan="2"><div class="hr hr1 hr-dotted"></div></td>
                      </tr> -->
