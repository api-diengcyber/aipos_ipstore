            ...
            <div class="row">
              ...
              <div class="<?php echo $cls ?> alert alert-warning">
                  <div class="form-group">
                      ...
                      <h3 style="margin:0px;"><?php echo $order->no_retur ?></h3>
                  </div>
                  <div class="form-group">
                      <label for="int">Tgl Retur</i></label><br>
                      <h3 style="margin:0px;"><?php echo $order->tgl_retur ?></h3>
                  </div>
              </div>
              <?php } ?>
            </div>
                  ...
                  <table id="" class="table table-condensed table-bordered table-hover">
                    ...
                    ?>
                      <tr style="background-color:<?php echo $color_tr ?>;color:<?php echo $color ?>;">
                        ...
                        <?php if ($data_login->level=='1') { ?>
                        <td>Rp. <span class="pull-right"><?php echo number_format($key->harga_beli,0,',','.') ?></span></td>
                        <?php } ?>
                        ...
                        <td>Rp. <span class="pull-right"><?php echo number_format($key->harga_satuan*$key->jumlah,0,',','.') ?></span></td>
                        <?php if ($data_login->level=='1') { ?>
