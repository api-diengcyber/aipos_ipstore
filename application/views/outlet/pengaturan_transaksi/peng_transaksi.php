          ...
          <?php
                    ...
                    <div class="tabbable">
                      <ul class="nav nav-tabs" id="myTab">
                        <li class="active">
                          <a data-toggle="tab" href="#penjualan">Tambah<br>Penjualan</a>
                        </li>
                        <li>
                          <a data-toggle="tab" href="#piutang">Pembayaran<br>Piutang</a>
                        </li>
                        <li>
                          <a data-toggle="tab" href="#buatreturjual">Buat Retur<br>Penjualan</a>
                        </li>
                        <!-- <li>
                          <a data-toggle="tab" href="#fakturpembelian">Tambah Faktur Pembelian</a>
                        </li> -->
                        <li>
                          <a data-toggle="tab" href="#pembelian">Pembelian<br>Ke Produksi</a>
                        </li>
                        <li>
                          <a data-toggle="tab" href="#pembelianproduksi">Pembelian<br>Dari Produksi</a>
                        </li>
                        <li>
                          <a data-toggle="tab" href="#pembeliankonsinyasi">Pembelian<br>Konsinyasi</a>
                        </li>
                        <li>
                          <a data-toggle="tab" href="#hutang">Pembayaran<br>Hutang</a>
                        </li>
                        <li>
                          <a data-toggle="tab" href="#buatretur">Buat Retur<br>Pembelian</a>
                        </li>
                        <li>
                          <a data-toggle="tab" href="#verifikasibayar">Verifikasi<br>Pembayaran</a>
                        </li>
                        <li>
                          <a data-toggle="tab" href="#saldoterbuka">Saldo<br>Terbuka</a>
                        </li>
                      </ul>
                      <div class="tab-content">
                        <div id="penjualan" class="tab-pane fade in active">
                          <form action="<?php echo base_url() ?>admin/pengaturan_transaksi/create_action" method="post">
                        ...
                        <div id="pembelianproduksi" class="tab-pane fade">
                          <form action="<?php echo base_url() ?>admin/pengaturan_transaksi/create_action" method="post">
                            <input type="hidden" name="jenis" value="pembelianproduksi">
                            <div class="row">
                              <div class="col-xs-4">
                                <h3 class="judul">Kode</h3>
                                <table class="table table-bordered">
                                  <tbody>
                                    <?php echo str_replace("[MENUPROSES]", "pembelianproduksi", $tbl_other) ?>
                                    <?php foreach ($data_kode_pembelianproduksi as $key): ?>
                                    <tr>
                                      <td width="100" class="clicker" name="pembelianproduksi">@<?php echo $key->kode ?>:</td>
                                      <td><?php echo $key->ket ?></td>
                                    </tr>
                                    <?php endforeach ?>
                                  </tbody>
                              ...
                              <div class="col-xs-8">
                                ...
                                <?php
                                $tpembelianproduksi = "";
                                if ($data_transaksi_pembelianproduksi) {
                                    $tpembelianproduksi = $data_transaksi_pembelianproduksi->kode;
                                }
                                ?>
                                <textarea name="text" id="textarea-pembelianproduksi" cols="30" rows="10" spellcheck="false"><?php echo $tpembelianproduksi ?></textarea>
                                <button type="submit" class="btn btn-primary">SIMPAN</button>
                              </div>
                            </div>
                          </form>
                        </div>
                        <div id="pembeliankonsinyasi" class="tab-pane fade">
                          <form action="<?php echo base_url() ?>admin/pengaturan_transaksi/create_action" method="post">
                            <input type="hidden" name="jenis" value="pembeliankonsinyasi">
                            <div class="row">
                              <div class="col-xs-4">
                                <h3 class="judul">Kode</h3>
                                <table class="table table-bordered">
                                  <tbody>
                                    <?php echo str_replace("[MENUPROSES]", "pembeliankonsinyasi", $tbl_other) ?>
                                    <?php foreach ($data_kode_pembeliankonsinyasi as $key): ?>
                                    <tr>
                                      <td width="100" class="clicker" name="pembeliankonsinyasi">@<?php echo $key->kode ?>:</td>
                                      <td><?php echo $key->ket ?></td>
                                    </tr>
                                    <?php endforeach ?>
                                  </tbody>
                              ...
                              <div class="col-xs-8">
                                <h3 class="judul">Tuliskan Proses</h3>
                                <?php
                                $tpembeliankonsinyasi = "";
                                if ($data_transaksi_pembeliankonsinyasi) {
                                    $tpembeliankonsinyasi = $data_transaksi_pembeliankonsinyasi->kode;
                                }
                                ?>
                                <textarea name="text" id="textarea-pembeliankonsinyasi" cols="30" rows="10" spellcheck="false"><?php echo $tpembeliankonsinyasi ?></textarea>
                                <button type="submit" class="btn btn-primary">SIMPAN</button>
                              </div>
                            </div>
                          </form>
                        ...
                        <div id="verifikasibayar" class="tab-pane fade">
                          <form action="<?php echo base_url() ?>admin/pengaturan_transaksi/create_action" method="post">
                            <input type="hidden" name="jenis" value="verifikasibayar">
                            <div class="row">
                              <div class="col-xs-4">
                                <h3 class="judul">Kode</h3>
                                <table class="table table-bordered">
                                  <tbody>
                                    <?php echo str_replace("[MENUPROSES]", "verifikasibayar", $tbl_other) ?>
                                    <?php foreach ($data_kode_verifikasibayar as $key): ?>
                                    <tr>
                                      <td width="100" class="clicker" name="verifikasibayar">@<?php echo $key->kode ?>:</td>
                                      <td><?php echo $key->ket ?></td>
                                    </tr>
                                    <?php endforeach ?>
                                  </tbody>
                              ...
                              <div class="col-xs-8">
                                ...
                                <?php
                                $tverifikasibayar = "";
                                if ($data_transaksi_verifikasibayar) {
                                  $tverifikasibayar = $data_transaksi_verifikasibayar->kode;
                                }
                                ?>
                                <textarea name="text" id="textarea-verifikasibayar" cols="30" rows="10" spellcheck="false"><?php echo $tverifikasibayar ?></textarea>
                                <button type="submit" class="btn btn-primary">SIMPAN</button>
                              </div>
                            </div>
                          </form>
                        ...
                        <div id="saldoterbuka" class="tab-pane fade">
                          <form action="<?php echo base_url() ?>admin/pengaturan_transaksi/create_action" method="post">
                            <input type="hidden" name="jenis" value="saldoterbuka">
                            <div class="row">
                              <div class="col-xs-4">
                                <h3 class="judul">Kode</h3>
                                <table class="table table-bordered">
                                  <tbody>
                                    <?php echo str_replace("[MENUPROSES]", "saldoterbuka", $tbl_other) ?>
                                    <?php foreach ($data_kode_saldoterbuka as $key): ?>
                                    <tr>
                                      <td width="100" class="clicker" name="saldoterbuka">@<?php echo $key->kode ?>:</td>
                                      <td><?php echo $key->ket ?></td>
                                    </tr>
                                    <?php endforeach ?>
                                  </tbody>
                              ...
                              <div class="col-xs-8">
                                ...
                                <?php
                                $tsaldoterbuka = "";
                                if ($data_transaksi_saldoterbuka) {
                                  $tsaldoterbuka = $data_transaksi_saldoterbuka->kode;
                                }
                                ?>
                                <textarea name="text" id="textarea-saldoterbuka" cols="30" rows="10" spellcheck="false"><?php echo $tsaldoterbuka ?></textarea>
                                <button type="submit" class="btn btn-primary">SIMPAN</button>
                              </div>
                            </div>
                          </form>
