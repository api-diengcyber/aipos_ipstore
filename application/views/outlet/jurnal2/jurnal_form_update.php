                  ...
                  <div class="row">
                    <div class="col-md-5">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="kode" id="kode" value="<?php echo $kode ?>" placeholder="Kode Jurnal" readonly />
                      </div>
                      <div class="form-group">
                    ...
                    <div class="col-md-7">
                      <table id="tabeldata" class="table table-bordered">
                        ...
                        foreach ($data_jurnal as $key) : ?>
                          <tr>
                            <td><?php echo $no ?></td>
                            <td style="padding:0px;"><select name="akun[]" class="form-control" style="border:none;">
                            <?php 
                            foreach ($data_akun as $key2) {
                              $s = '';
                              if ($key2->id == $key->id_akun) {
                                $s = 'selected';
                              }
                              echo '<option value="'.$key2->id.'" '.$s.'>'.$key2->kode.' ---- '.$key2->akun.'</option>';
                            }
                            ?>
                            </select></td>
                            <td style="padding:0px;"><input type="text" name="debet[]" class="form-control text-right numbering val_debet" value="<?php echo number_format($key->debet,0,',','.') ?>" style="border:none;" placeholder="0" /></td>
                            <td style="padding:0px;"><input type="text" name="kredit[]" class="form-control text-right numbering val_kredit" value="<?php echo number_format($key->kredit,0,',','.') ?>" style="border:none;" placeholder="0" /></td>
                          </tr>
                        <?php 
                        $no++;
                        endforeach
...
$(document).ready(function(){
  ...
  akun_option += '</select>';
  var i = <?php echo count($data_jurnal)*1 ?>;
