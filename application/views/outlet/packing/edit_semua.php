        ...
        <div class="main-content-inner">
          <div class="breadcrumbs ace-save-state breadcrumbs-fixed" id="breadcrumbs">
            <ul class="breadcrumb">
              ...
              <li class="">Packing</li>
              <li class="active">Packing Order</li>
            </ul><!-- /.breadcrumb -->
          ...
          <div class="page-content">
            ...
            <div class="row">
              <div class="col-xs-12">
                ...
                <a href="<?php echo base_url() ?>produk_retail" class="btn btn-default"><< Kembali</a>
...
jQuery(function($){
  ...
  function loadData(data) {
    $.ajax({
      url: '<?php echo base_url() ?>packing/packing/json',
      type: 'get',
  ...
  function saveData(data, result) {
    $.ajax({
      url: '<?php echo base_url() ?>packing/packing/save_edit_semua',
      type: 'post',
