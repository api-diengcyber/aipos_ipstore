              ...
              <div class="col-md-6">
                <!-- PAGE CONTENT BEGINS -->
                    ...
                    <div class="form-group">
                      <?php 
                      if($parent==null){?>
                        <label for="bigint">Barcode / IMEI <?php echo form_error('barcode') ?>
                        <a href="<?php echo base_url('admin/produk_retail/create?id_barcode=1'); ?>">(Buat Barcode)</a>
                      </label> 
                         <input type="text" class="form-control" name="barcode" id="barcode" placeholder="Barcode / IMEI" value="<?php echo $barcode; ?>" />
                      <?php
                      }else{?>
                            <label for="bigint">Barcode / IMEI <?php echo form_error('barcode') ?></label> 
                            <input type="text" class="form-control" name="barcode" id="barcode" placeholder="Barcode / IMEI" value="<?php echo $parent->barcode; ?>" />
                      <?php                        
                        }
                      ?>                       
