                ...
                <table class="table table-bordered table-striped" id="mytable">
                    ...
                    <tbody>
                      ...
                      <tr style="<?php echo $tr_style ?>">
                        ...
                        <td>
                          <a onclick="return confirm('Are you sure ?')" href="<?php echo base_url() ?>admin/returjual/proses_action/<?php echo $order_sales->id_order ?>/cod" class="btn btn-primary btn-xs">Retur COD</a>
                          <a onclick="return confirm('Are you sure ?')" href="<?php echo base_url() ?>admin/returjual/proses_action/<?php echo $order_sales->id_order ?>/garansi" class="btn btn-primary btn-xs">Retur Garansi</a>
                        </td>
                      </tr>
                      <?php endforeach ?>
                    </tbody>
