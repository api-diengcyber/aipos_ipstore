                ...
                <div class="alert alert-info">
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <textarea name="no_resi" placeholder="Masukan nomor resi disini, pisahkan dengan enter" id="" cols="30" rows="4" class="form-control"><?php echo $no_resi ?></textarea>
                        <button type="submit" class="btn btn-primary mt-2 btn-sm" style="margin-top:10px">PROSES</button>
                      </div>
                    </div>
                </div>
                      ...
                      foreach ($data_order as $order_sales):
                        ...
                        foreach ($order_sales->detail_order as $dtkey) :
                          /* if ($dtkey->id_produk == "1") {
                            $harga_hs = $dtkey->harga_jual;
                          }
                          if ($dtkey->id_produk == "2") {
                            $harga_gc = $dtkey->harga_jual;
                          } */
