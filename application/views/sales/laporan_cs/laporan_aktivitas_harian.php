                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        if ($dtp['kode_produk'] == "GC") {
                          echo '<td rowspan="2" class="text-center" style="vertical-align:middle;">'.$dtp['date'].'</td>';
                        }
                        ?>
                        ...
                        foreach ($data_media as $key_m) :
                          foreach ($data_gpc as $k_g) :
                            $nom = 0;
                            $row = $that->get_jumlah_order_day($dtp['date'], $key_m->id, $id_group, $k_g->id_produk);
                            if ($row) {
                              $nom = $row->jml;
                            }
