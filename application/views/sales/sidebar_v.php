      ...
      <div id="sidebar" class="sidebar responsive ace-save-state sidebar-fixed">
        ...
        <ul class="nav nav-list">
          ...
          <li class="<?php if(isset($active_penjualan_create) || isset($active_orde_sales) || isset($active_order_sales_diterima) || isset($active_penjualan_sales) || isset($active_retur_penjualan_create) || isset($active_retur_penjualan_manual_create ) || isset($active_order_sales)){ echo 'active open';}; ?> highlight">
            ...
            <ul class="submenu">
              ...
              <li class="<?php if(isset($active_retur_penjualan_create)){ echo $active_retur_penjualan_create;}; ?> highlight">
                <a href="<?php echo base_url() ?>admin/returjual">
