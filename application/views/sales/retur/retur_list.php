              ...
              <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                    ...
                    <form method="post" id="formPeriode" class="form-horizontal" action="">
                      <div class="row">
                        <div class="col-md-2">
                          <a href="<?php echo base_url() ?>admin/retur/create" class="btn btn-primary">Tambah Retur</a>
                        </div>
                        <div class="col-md-8">
                      ...
                      <table id="mytable" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td class="center"><a href="<?php echo base_url() ?>admin/retur/read/<?php echo $key->id ?>" class="btn btn-xs btn-success"><i class="ace-icon fa fa-check bigger-120"></i></a>&nbsp;&nbsp;<a onclick="javascript:return confirm('Are you sure ?')" href="<?php echo base_url() ?>admin/retur/delete/<?php echo $key->id ?>" class="btn btn-xs btn-danger"><i class="ace-icon fa fa-trash bigger-120"></i></a></td>
                          </tr>
                          <?php
                          $no++;
                          endforeach;
