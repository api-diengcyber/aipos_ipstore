              ...
              <div class="col-xs-12">
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <a onclick="return confirm('Are you sure ?')" href="<?php echo base_url() ?>admin/retur_jual/reset_temp" class="btn btn-danger">Reset</a>
                  </div>
                </div>
                </form>
                <!-- PAGE CONTENT ENDS -->
...
$(document).ready(function(){
  ...
  function insertTemp(barcode) {
    $.ajax({
      url: '<?php echo base_url() ?>admin/retur_jual/insert_temp_manual',
      type: 'post',
  ...
  function refreshTemp() {
    ...
    // $("#mytable>tbody").html('');
    $.ajax({
      url: '<?php echo base_url() ?>admin/retur_jual/tabelTempManual',
      type: 'get',
      success: function(response) {
        $("#nama_barang").removeAttr('disabled');
        $("#nama_barang").val('');
  ...
  function updateTemp(params) {
    $.ajax({
      url: '<?php echo base_url() ?>admin/retur_jual/update_temp_manual',
      type: 'post',
      data: params,
      success: function(response) {
        refreshTemp();
