...
<script>
  jQuery(function($){
    ...
    var tampil = function(id){
      ...
      $.ajax({
        url: '<?php echo base_url() ?>admin/pengaturan_jurnal/data',
        type: 'post',
    ...
    $("#debet").change(function(){
      ...
      $.ajax({
        url: '<?php echo base_url() ?>admin/pengaturan_jurnal/create_action',
        type: 'post',
    ...
    var addFuncDeleteAkun = function(){
      $("[data-button-id]").click(function(){
        ...
        $.ajax({
          url: '<?php echo base_url() ?>admin/pengaturan_jurnal/delete/'+id_pengaturan,
          success: function(response){
            tampil(id_pil_jurnal);
          }
        });
