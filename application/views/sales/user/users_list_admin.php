            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="row" style="margin-bottom: 10px">
                    <div class="col-md-4">
                        <?php echo anchor(site_url('admin/user_retail/create'), 'Tambah', 'class="btn btn-primary"'); ?>
                    </div>
                ...
                <script type="text/javascript">
                    $(document).ready(function() {
                        ...
                        var t = $("#mytable").dataTable({
                            ...
                            processing: true,
                            serverSide: true,
                            ajax: {"url": "<?php echo base_url() ?>admin/user_retail/json/admin", "type": "POST"},
                            columns: [
                                {
                                    "data": "id_users",
                                    "orderable": false
                                },{"data": "email"},{"data": "first_name"},{"data": "last_name"},{"data": "alamat"},{"data": "phone"},{"data": "t_level", "searchable": false },{"data": "t_active", "searchable": false },
                                {
                                    "data" : "action",
                                    "orderable": false,
