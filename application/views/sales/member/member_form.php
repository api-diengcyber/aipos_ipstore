                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="custom_code" value="00" style="width:50px;" maxlength="3" />
                            </span>
                          </div>
                      </div>
                      <?php } ?>
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                          ...
                          <select class="form-control" name="uid_akun" id="uid_akun">
                            ...
                            <option value="<?php echo $key->uid ?>" <?php echo $uid_akun==$key->uid?"selected":"" ?>><?php echo $key->kode.". ".$key->akun ?></option>
                            <?php endforeach; ?>
                          </select>
                      </div>
                      <div class="form-group">
                          ...
                          <select class="form-control" name="id_gudang" id="id_gudang">
                            ...
                            <option value="<?php echo $key->id ?>" <?php echo $id_gudang==$key->id?"selected":"" ?>><?php echo $key->nama_gudang ?></option>
                            <?php endforeach; ?>
                          </select>
                      </div>
                    </div>
